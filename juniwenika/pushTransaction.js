...
const url = "http://xxx.xxx.xxx.xxx:8888";

const json_rpc = new JsonRpc(url);
const private_key = process.env.PRIVATE_KEY; // import private key from .env file;

const account = "juniwenika";
const actor = "juniwenika";
...
const DestroyTrancsaction = async (id) => {
  try {
    ...
    console.log("Record destroyed by juniwenika\n\n");
...
PushTransaction(1020, account, "test push transaction by juniwenika");
