...
const DestroyTrancsaction = async (id) => {
  try {
    ...
    console.log("Record destroyed by mamatkun1\n\n");
...
PushTransaction(1020, account, "test push transaction by mamatkun1");
