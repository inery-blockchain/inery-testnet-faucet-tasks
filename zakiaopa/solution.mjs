...
const url = "http://vmi990974.contaboserver.net:8888"

const json_rpc = new JsonRpc(url) 
const private_key = "5JoWDMN9gjbjJjobyCHxzRVTArdVLdNnpAKVxMbLP5gAZ3YpaCv"; 
const actor = "zakiaopa.serv1"

const account = "zakiaopa"
