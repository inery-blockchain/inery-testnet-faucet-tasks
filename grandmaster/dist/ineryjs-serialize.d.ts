 ...
 * @module Serialize
 */
import { TransactionHeader } from './ineryjs-api-interfaces';
import { Abi, BlockTaposInfo } from './ineryjs-rpc-interfaces';
import { Query } from './ineryjs-api-interfaces';
/** A field in an abi */
 ...
 *          * Else, value must be ineryjs-compatible with the specified type (e.g. uint64 should be a string
