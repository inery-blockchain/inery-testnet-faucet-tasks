...
var PublicKey = /** @class */ (function () {
    ...
    PublicKey.fromString = function (publicKeyStr, ec) {
        var key = ineryjs_numeric_1.stringToPublicKey(publicKeyStr);
        if (!ec) {
            ec = ineryjs_key_conversions_1.constructElliptic(key.type);
        }
    ...
    PublicKey.prototype.toString = function () {
        return ineryjs_numeric_1.publicKeyToString(this.key);
    };
    /** Export public key as Legacy INERYIO-format public key */
    PublicKey.prototype.toLegacyString = function () {
        return ineryjs_numeric_1.publicKeyToLegacyString(this.key);
    };
