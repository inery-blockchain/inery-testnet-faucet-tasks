...
// A Function to read data in our Valued Smart Contract, and call "read" function on our Smart contract
    ...
    try{
        ...
        const tx = await api.transact({
            actions:[
                {
                  account,
                  name:"read", // check your name function at contact for read
                  authorization:[
                        {
                            actor,
                            permission:"active"
