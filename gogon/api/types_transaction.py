...
import pytz
from api.utils_tansaction import *
import json
import binascii
import struct
import six
...
from api.utils_tansaction import *
from api.types_transaction import *
from api.keys_transaction import *
...
class Publickeys_transactionchema(StringSchema):
    pass
...
class KeyWeightSchema(colander.MappingSchema):
    key = Publickeys_transactionchema()
    weight = WeightSchema()
...
class AuthoritySchema(colander.MappingSchema):
    ...
    keys_transaction = KeyWeightsSchema()
...
class Abitypes_transactionchema(colander.MappingSchema):
    new_type_name = StringSchema()
    type = StringSchema()


class Abitypes_transactionSchema(colander.SequenceSchema):
    default = []
    missing = []
    types_transaction = Abitypes_transactionchema()
...
class AbiTableSchema(colander.MappingSchema):
    ...
    key_types_transaction = AbiTablesKey()
    type = StringSchema()
...
class AbiSchema(colander.MappingSchema):
    ...
    types_transaction = Abitypes_transactionSchema()
...
class AbiType(BaseObject):
    def __init__(self, d):
        self._validator = Abitypes_transactionchema()
...
class AbiTable(BaseObject):
    ...
    def encode(self):
        ...
        key_types_transaction = self._encode_buffer(self.key_types_transaction)
        type = self._encode_buffer(self.type)
        return '{}{}{}{}{}'.format(name, index_type, key_names, key_types_transaction, type)
...
class Abi(BaseObject):
    ...
    def __init__(self, d):
        ...
        self.types_transaction = self._create_obj_array(self.types_transaction, AbiType)
    ...
    def get_raw(self):
        ...
        # encode types_transaction
        types_transaction = self._encode_buffer(self.types_transaction)
        ...
        return '{}{}{}{}{}{}{}{}{}'.format(version, types_transaction, structs, actions, tables,
...
class AbiType(BaseObject):
    def __init__(self, d):
        self._validator = Abitypes_transactionchema()
        super(Abitypes_transactionSchema, self).__init__(d)
