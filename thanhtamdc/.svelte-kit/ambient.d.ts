...
declare module '$env/static/private' {
	...
	export const CARDCHAIN_CHAIN_ID: string;
	export const _: string;
	export const npm_config_prefix: string;
	export const XDG_SESSION_CLASS: string;
	export const BCL: string;
	export const TERM: string;
	export const XDG_SESSION_ID: string;
	export const npm_config_cache: string;
	export const NIBIRU_PORT: string;
	export const TDLimit_price: string;
	...
	export const CARDCHAIN_PORT: string;
	...
	export const CARDCHAIN_WALLET_ADDRESS: string;
	export const SEIRPC: string;
	export const npm_package_version: string;
	export const npm_lifecycle_event: string;
	export const CARDCHAIN_VALOPER_ADDRESS: string;
	export const LESSCLOSE: string;
	export const KEY: string;
	export const LC_MEASUREMENT: string;
	export const DQP: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		SHELL: string;
		LC_NAME: string;
		CARDCHAIN_WALLET_ADDRESS: string;
		SEIRPC: string;
		npm_package_version: string;
		npm_lifecycle_event: string;
		CARDCHAIN_VALOPER_ADDRESS: string;
		LESSCLOSE: string;
		KEY: string;
