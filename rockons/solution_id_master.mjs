...
async function Updateidchain(data){
  try{
    var name = "update"
...
async function DestroyidTX(data){
  try{
    var name = "destroy"
...
// Call all function
async function TxDetailid(data){
  await CreatidTx(data)
  await idReadTx(data)
  await Updateidchain(data)
  await DestroyidTX(data)
}
