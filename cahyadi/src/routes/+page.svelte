...
<div class="bg-gradient-to-t from-blue-500 mx-auto min-h-screen px-20 pb-20 pt-20">
    <div class="flex justify-center">
        <div on:click={() => goto("https://github.com/Cahyadi190/inery-testnet-faucet-tasks/tree/task5")} class="avatar relative cursor-pointer mb-4">
            <div class="w-8 h-8 rounded-full absolute z-20 bottom-0 right-0">
            </div>
            <div class="w-20 mask mask-box">
              <img src="https://avatars.githubusercontent.com/u/97181725?v=4" />
            </div>
          </div>
    </div>
    <div class="mb-4 text-left">
        <div class="text-5xl font-bold bg-gradient-to-r from-blue-500 bg-clip-text text-transparent">INERY BLOCKCHAIN</div>
        <div class="mt-10 font-bold">Click button to run the blockchain transaction after the transaction executed you will see a blockchain log in the bottom</div>
    </div>

    <div class="grid grid-cols-4 gap-4">
        <label for="modal-create" class="btn">CREATE</label>
...
<Modal modal_id="modal-create" modal_title="Create New Record on IneryDB" on:click={() => create()}>
    <div slot="body" class="flex flex-col gap-4">
        ...
        <input type="text" placeholder="cahyadi" class="input input-bordered w-full max-w-xs" disabled />
