...
// A Function to build new data in our Valued Smart Contract, and call "issue" function on our Smart contract
...
// call RPC that we created in issue function
issue(actor, token, "issue form rpc")