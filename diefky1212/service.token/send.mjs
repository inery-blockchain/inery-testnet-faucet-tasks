...
// A Function to create new data in our Valued Smart Contract, and call "send" function on our Smart contract
async function send(from, to, quantity, memo){
    try{
...
create(actor, "inery", token, "send From RPC")