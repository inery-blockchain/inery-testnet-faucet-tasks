...
// A Function to destroy data in our Valued Smart Contract, and call "dbdestroy" function on our Smart contract
...
// call RPC that we delete in destroy function
deleting(1, actor, "destroy data from rpc")