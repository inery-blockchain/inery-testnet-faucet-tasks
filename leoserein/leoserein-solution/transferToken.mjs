iimport { Api, JsonRpc,JsSignatureProvider } from 'ineryjs/dist/index.js'
...
async function transferToken(from, to, token, amount, message){ 
    try{
...
transferToken(account, actor, token, amount, message)