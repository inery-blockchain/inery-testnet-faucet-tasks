...
exports.ecc = void 0;
var ineryjs_jssig_1 = require("./ineryjs-jssig");
...
exports.ecc = {
    ...
    randomKey: function (cpuEntropyBits, options) {
        ...
        var privateKey = ineryjs_key_conversions_1.generateKeyPair(ineryjs_numeric_1.KeyType.k1, options).privateKey;
    ...
    privateToPublic: function (key, pubkey_prefix) {
        ...
        var privateKey = ineryjs_jssig_1.PrivateKey.fromString(key);
    ...
    isValidPublic: function (pubkey, pubkey_prefix) {
        ...
        try {
            var publicKey = ineryjs_jssig_1.PublicKey.fromString(pubkey);
    ...
    isValidPrivate: function (wif) {
        try {
            var privateKey = ineryjs_jssig_1.PrivateKey.fromString(wif);
    ...
    sign: function (data, privateKey, encoding) {
        ...
        var privKey = typeof privateKey === 'string' ? ineryjs_jssig_1.PrivateKey.fromString(privateKey) : privateKey;
    ...
    verify: function (signature, data, pubKey, encoding, hashData) {
        ...
        var publicKey = typeof pubKey === 'string' ? ineryjs_jssig_1.PublicKey.fromString(pubKey) : pubKey;
        var sig = ineryjs_jssig_1.Signature.fromString(signature);
    ...
    sha256: function (data, resultEncoding, encoding) {
        ...
        return require('./ineryjs-key-conversions').sha256(data);
    }
};