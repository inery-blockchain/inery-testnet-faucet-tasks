    ...
    <div class="flex justify-center">
        <div on:click={() => goto("https://github.com/Mbokde/inery-testnet-faucet-tasks/tree/task5/mbokde")} class="avatar relative cursor-pointer mb-4">
            ...
            <div class="w-24 mask mask-hexagon">
              <img src="https://avatars.githubusercontent.com/u/103348533?v=4" />
            </div>
          </div>
    </div>
    <div class="mb-10 text-center">
        <div class="text-4xl font-bold ">Inery DAPP by Mbokde</div>
...
<Modal modal_id="modal-create" modal_title="Create New Record on IneryDB" on:click={() => create()}>
    <div slot="body" class="flex flex-col gap-4">
        ...
        <input type="text" placeholder="mbokde" class="input input-bordered w-full max-w-xs" disabled />
