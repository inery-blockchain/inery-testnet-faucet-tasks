...
async function tx_data_id(data){
  try{
    var name = "create"
...
async function tx_destroy(data){
  try{
    var name = "destroy"
...
// Call all function
async function tx_detail(data){
  await tx_detail_id(data)
  await tx_read(data)
  await tx_update(data)
  await tx_delete(data)
}
