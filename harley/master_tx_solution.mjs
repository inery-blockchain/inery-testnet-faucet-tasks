...
async function CreateTransactionChain(data){
  try{
    var name = "create"
...
async function ReadTxTransaction(data){
  try{
    var name = "read"
...
async function UpdateTxTransaction(data){
  try{
    var name = "update"
...
// Function to DESTROY transaction
async function DestroyTxinery(data){
  try{
    var name = "destroy"
...
// Call all function
async function TransactionTxDetail(data){
  await CreateTransactionChain(data)
  await ReadTxTransaction(data)
  await UpdateTxTransaction(data)
  await DestroyTxinery(data)
}


// Execute push transaction
TransactionTxDetail(data)
