...
const accountID = process.env.USER_ACC_NAME
const actor = account
const id = process.env.DATA_ID
const createDat = process.env.CREATE_CRUD_DATA
...
async function createCrud(id, user, data){
	...
	console.log("\x1b[0m")
        ...
        console.log("\x1b[1;7;92m")
	console.log("RPC Push transaction")
	console.log("\x1b[0m")
...
createCrud(id, accountID, createDat)
