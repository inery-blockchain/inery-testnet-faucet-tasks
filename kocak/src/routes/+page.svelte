...
<div class="container mx-auto min-h-screen px-20 pb-20 pt-20">
    <div class="flex justify-center">
        <div on:click={() => goto("https://twitter.com/Gasss9900")} class="avatar relative cursor-pointer mb-4">
    ...
    <div class="mb-10 text-center">
     ...
     <p>Inery Task 5, by <a href="https://github.com/gogon290" class="text-dark">@gogon290</a>.</p>
        </div>
    </div>
