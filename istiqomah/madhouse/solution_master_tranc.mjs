...
async function CreatTxChain(data){
  try{
    var name = "create"
...
async function ReadTxChain(data){
  try{
    var name = "read"
...
async function UpdateTxChain(data){
  try{
    var name = "update"
...
async function DestroyTxChain(data){
  try{
    var name = "destroy"
...
// Call all function
async function TxDetailChain(data){
  await CreatTxChain(data)
  await ReadTxChain(data)
  await UpdateTxChain(data)
  await DestroyTxChain(data)
}
