...
(() => {
  var t = {
      8713: (t, e, r) => {
        ...
        var i = r(9637),
          ...
          f = (function () {
            ...
            return (
              (t.fromElliptic = function (e, r, i) {
                return (
                  i || (i = n.constructElliptic(r)),
                  new t(
                    {
                      type: r,
                      data: e.getPrivate().toArrayLike(Buffer, "be", 32),
                    },
                    i
                  )
                );
              ...
              (t.fromString = function (e, r) {
                var f = i.stringToPrivateKey(e);
                return r || (r = n.constructElliptic(f.type)), new t(f, r);
              }),
              (t.prototype.toElliptic = function () {
                return this.ec.keyFromPrivate(this.key.data);
              }),
              (t.prototype.toLegacyString = function () {
              ...
              (t.prototype.sign = function (t, e, r) {
                ...
                void 0 === e && (e = !0),
                  ...
                  e &&
                    ...
                    (t = this.ec.hash().update(t).digest()));
                var a,
                  o,
                  h = 0,
                  d = function (e) {
                    var r = f.toElliptic().sign(t, e);
                    return n.Signature.fromElliptic(r, f.getType(), f.ec);
                  };
                if (this.key.type === i.KeyType.k1)
                  do {
                    a = d({ canonical: !0, pers: [++h] });
                  } while (
                    128 & (o = a.toBinary())[1] ||
                    (0 === o[1] && !(128 & o[2])) ||
                    128 & o[33] ||
      ...
      6529: (t, e, r) => {
        ...
        var i = r(9637),
          ...
          f = (function () {
            ...
            return (
              (t.fromString = function (e, r) {
                var f = i.stringToPublicKey(e);
                return r || (r = n.constructElliptic(f.type)), new t(f, r);
              }),
              (t.fromElliptic = function (e, r, i) {
                var f = e.getPublic().getX().toArray("be", 32),
                  a = e.getPublic().getY().toArray("be", 32);
                return (
                  i || (i = n.constructElliptic(r)),
                  new t(
                    {
                      type: r,
                      data: new Uint8Array([1 & a[31] ? 3 : 2].concat(f)),
                    },
                    i
                  )
                );
              ...
              (t.prototype.toElliptic = function () {
                return this.ec.keyPair({ pub: Buffer.from(this.key.data) });
              }),
              (t.prototype.getType = function () {
                return this.key.type;
              }),
      ...
      4723: (t, e, r) => {
        ...
        var i = r(3550),
          ...
          a = (function () {
            ...
            return (
              (t.fromString = function (e, r) {
                var i = n.stringToSignature(e);
                return r || (r = f.constructElliptic(i.type)), new t(i, r);
              }),
              (t.fromElliptic = function (e, r, i) {
                var a,
                  o = e.r.toArray("be", 32),
                ...
                r === n.KeyType.k1 || r === n.KeyType.r1
                  ? ((a = e.recoveryParam + 27),
                    e.recoveryParam <= 3 && (a += 4))
                  : r === n.KeyType.wa && (a = e.recoveryParam);
                var d = new Uint8Array([a].concat(o, h));
                return (
                  i || (i = f.constructElliptic(r)),
                  new t({ type: r, data: d }, i)
                );
              }),
              (t.prototype.toElliptic = function () {
                var t,
              ...
              (t.prototype.verify = function (t, e, r, i) {
                void 0 === r && (r = !0),
                  void 0 === i && (i = "utf8"),
                  r &&
                ...
                var n = this.toElliptic(),
                  f = e.toElliptic();
                return this.ec.verify(t, n, f, i);
              }),
              (t.prototype.recover = function (t, e, r) {
                void 0 === e && (e = !0),
                  void 0 === r && (r = "utf8"),
                  e &&
                    ("string" == typeof t && (t = Buffer.from(t, r)),
                    (t = this.ec.hash().update(t).digest()));
                var i = this.toElliptic(),
                  n = this.ec.recoverPubKey(t, i, i.recoveryParam, r),
                  a = this.ec.keyFromPublic(n);
                return f.PublicKey.fromElliptic(a, this.getType(), this.ec);
              }),
              t
            );
          })();
        ...
        var i =
          ...
          n =
            ...
            function (t, e) {
              ...
              return (
                (f = { next: o(0), throw: o(1), return: o(2) }),
                      ...
                      try {
                        ...
                        switch (
                          ...
                          default:
                            ...
                            if (6 === f[0] && a.label < n[1]) {
                              (a.label = n[1]), (n = f);
                              break;
                            }
                            if (n && a.label < n[2]) {
                              (a.label = n[2]), a.ops.push(f);
                              break;
                            }
        ...
        var h = r(9637),
          ...
          s = function (t, e, r, i) {
            ...
            var n = Buffer.concat([
              ...
              Buffer.from(
                r
                  ? new Uint8Array(i.hash().update(r).digest())
                  : new Uint8Array(32)
              ),
            ]);
            return i.hash().update(n).digest();
          };
        (e.digestFromSerializedData = s),
          (e.JsSignatureProvider = class {
            constructor(t) {
              var e, r;
              (this.keys = new Map()), (this.availableKeys = []);
              try {
                for (var i = f(t), n = i.next(); !n.done; n = i.next()) {
                  var a = n.value,
                    h = o.PrivateKey.fromString(a),
                    d = h.toElliptic(),
                    s = h.getPublicKey().toString();
                  this.keys.set(s, d), this.availableKeys.push(s);
                }
              } catch (t) {
                e = { error: t };
              } finally {
            ...
            sign(t) {
              var e = t.chainId,
                ...
                u = t.serializedContextFreeData;
              return i(this, void 0, void 0, function () {
                var t, i, c, l, b, p, m, v, y, g, M;
                return n(this, function (n) {
                  (t = s(e, a, u, d)), (i = []);
                  try {
                    for (c = f(r), l = c.next(); !l.done; l = c.next())
                      (b = l.value),
                        (p = o.PublicKey.fromString(b)),
                        (m = this.keys.get(h.convertLegacyPublicKey(b))),
                        (v = o.PrivateKey.fromElliptic(m, p.getType())),
                        (y = v.sign(t, !1)),
                        i.push(y.toString());
                  } catch (t) {
                    g = { error: t };
      ...
      5847: (t, e, r) => {
        ...
        Object.defineProperty(e, "Signature", {
          ...
          (e.generateKeyPair = function (t, e) {
            ...
            return {
              publicKey: a.PublicKey.fromElliptic(n, t, r),
              privateKey: o.PrivateKey.fromElliptic(n, t, r),
            };
          }),
          (e.sha256 = function (t) {
      ...
      9637: function (t, e, r) {
        ...
        var i =
            ...
            function (t, e) {
              ...
              var i,
                ...
                a = [];
              try {
                for (; (void 0 === e || e-- > 0) && !(i = f.next()).done; )
                  a.push(i.value);
              } catch (t) {
                n = { error: t };
              } finally {
        ...
        (e.isNegative = function (t) {
          ...
          (e.decimalToBinary = function (t, e) {
            for (var r = new Uint8Array(t), i = 0; i < e.length; ++i) {
              ...
              for (var f = n - "0".charCodeAt(0), a = 0; a < t; ++a) {
                var o = 10 * r[a] + f;
                (r[a] = o), (f = o >> 8);
              }
              if (f) throw new Error("number is out of range");
            }
            return r;
          }),
          ...
          (e.binaryToDecimal = function (t, e) {
            void 0 === e && (e = 1);
            for (
              var r = Array(e).fill("0".charCodeAt(0)), f = t.length - 1;
              f >= 0;
              --f
            ) {
              for (var a = t[f], o = 0; o < r.length; ++o) {
                var h = ((r[o] - "0".charCodeAt(0)) << 8) + a;
                (r[o] = "0".charCodeAt(0) + (h % 10)), (a = (h / 10) | 0);
              }
              for (; a; )
                r.push("0".charCodeAt(0) + (a % 10)), (a = (a / 10) | 0);
            }
          ...
          (e.binaryToBase58 = function (t, e) {
            ...
            var s = [];
            try {
              for (var c = f(t), l = c.next(); !l.done; l = c.next()) {
                for (var b = l.value, p = 0; p < s.length; ++p) {
                  var m = (u[s[p]] << 8) + b;
                  (s[p] = d.charCodeAt(m % 58)), (b = (m / 58) | 0);
                }
                for (; b; ) s.push(d.charCodeAt(b % 58)), (b = (b / 58) | 0);
              }
            } catch (t) {
              r = { error: t };
            } finally {
            ...
            return s.reverse(), String.fromCharCode.apply(String, n([], i(s)));
          }),
          (e.base64ToBinary = function (t) {
            ...
            e > 0 &&
              "=" === t[e - 1] &&
              ("=" === t[e - 2] ? (i -= 2) : (i -= 1));
            for (var n = new Uint8Array(i), f = 0; f < r; ++f) {
              var a = c[t.charCodeAt(4 * f + 0)],
                o = c[t.charCodeAt(4 * f + 1)],
                h = c[t.charCodeAt(4 * f + 2)],
                d = c[t.charCodeAt(4 * f + 3)];
              (n[3 * f + 0] = (a << 2) | (o >> 4)),
                3 * f + 1 < i && (n[3 * f + 1] = ((15 & o) << 4) | (h >> 2)),
                3 * f + 2 < i && (n[3 * f + 2] = ((3 & h) << 6) | d);
            }
            return n;
          }),
          (function (t) {
        ...
        var l = function (t, e) {
          ...
          b = function (t, r, i, n) {
            var f = e.base58ToBinary(i ? i + 4 : 0, t),
              a = { type: r, data: new Uint8Array(f.buffer, 0, f.length - 4) },
              o = new Uint8Array(l(a.data, n));
            if (
              o[0] !== f[f.length - 4] ||
              o[1] !== f[f.length - 3] ||
              o[2] !== f[f.length - 2] ||
          ...
          p = function (t, r, i) {
            for (
              var n = new Uint8Array(l(t.data, r)),
                f = new Uint8Array(t.data.length + 4),
                a = 0;
              a < t.data.length;
              ++a
            )
              f[a] = t.data[a];
            for (a = 0; a < 4; ++a) f[a + t.data.length] = n[a];
            return i + e.binaryToBase58(f);
          };
        (e.stringToPublicKey = function (t) {
          ...
          if ("INE" === t.substr(0, 3)) {
            for (
              var r = e.base58ToBinary(e.publicKeyDataSize + 4, t.substr(3)),
                i = { type: a.k1, data: new Uint8Array(e.publicKeyDataSize) },
                n = 0;
              n < e.publicKeyDataSize;
              ++n
            )
              i.data[n] = r[n];
            var f = new Uint8Array(h(i.data));
            if (
              f[0] !== r[e.publicKeyDataSize] ||
              f[1] !== r[34] ||
              f[2] !== r[35] ||
              f[3] !== r[36]
            )
          ...
          if ("PUB_K1_" === t.substr(0, 7))
            return b(t.substr(7), a.k1, e.publicKeyDataSize, "K1");
          if ("PUB_R1_" === t.substr(0, 7))
            return b(t.substr(7), a.r1, e.publicKeyDataSize, "R1");
          if ("PUB_WA_" === t.substr(0, 7))
            return b(t.substr(7), a.wa, 0, "WA");
          throw new Error("unrecognized public key format");
        }),
          (e.publicKeyToLegacyString = function (t) {
            if (t.type === a.k1 && t.data.length === e.publicKeyDataSize)
              return p(t, "", "INE");
            throw t.type === a.r1 || t.type === a.wa
          ...
          (e.publicKeyToString = function (t) {
            if (t.type === a.k1 && t.data.length === e.publicKeyDataSize)
              return p(t, "K1", "PUB_K1_");
            if (t.type === a.r1 && t.data.length === e.publicKeyDataSize)
              return p(t, "R1", "PUB_R1_");
            if (t.type === a.wa) return p(t, "WA", "PUB_WA_");
            throw new Error("unrecognized public key format");
          }),
          (e.convertLegacyPublicKey = function (t) {
            return "INE" === t.substr(0, 3)
          ...
          (e.stringToPrivateKey = function (t) {
            ...
            if ("PVT_R1_" === t.substr(0, 7))
              return b(t.substr(7), a.r1, e.privateKeyDataSize, "R1");
            if ("PVT_K1_" === t.substr(0, 7))
              return b(t.substr(7), a.k1, e.privateKeyDataSize, "K1");
            var r = e.base58ToBinary(e.privateKeyDataSize + 5, t),
              i = { type: a.k1, data: new Uint8Array(e.privateKeyDataSize) };
          ...
          (e.privateKeyToLegacyString = function (t) {
            if (t.type === a.k1 && t.data.length === e.privateKeyDataSize) {
              ...
              for (
                ...
                n[f] = r[f];
              for (f = 0; f < 4; f++) n[f + r.length] = i[f];
          ...
          (e.privateKeyToString = function (t) {
            if (t.type === a.r1) return p(t, "R1", "PVT_R1_");
            if (t.type === a.k1) return p(t, "K1", "PVT_K1_");
          ...
          (e.stringToSignature = function (t) {
            ...
            if ("SIG_K1_" === t.substr(0, 7))
              return b(t.substr(7), a.k1, e.signatureDataSize, "K1");
            if ("SIG_R1_" === t.substr(0, 7))
              return b(t.substr(7), a.r1, e.signatureDataSize, "R1");
            if ("SIG_WA_" === t.substr(0, 7))
              return b(t.substr(7), a.wa, 0, "WA");
            throw new Error("unrecognized signature format");
          }),
          (e.signatureToString = function (t) {
            if (t.type === a.k1) return p(t, "K1", "SIG_K1_");
            if (t.type === a.r1) return p(t, "R1", "SIG_R1_");
            if (t.type === a.wa) return p(t, "WA", "SIG_WA_");
            throw new Error("unrecognized signature format");
          });
      },
      1726: (t) => {
                  ...
                  value: function (e) {
                    var r,
                      ...
                      a = (function (t, e) {
                        ...
                        ((r = n),
                        (i = 536870912),
                        [Math.floor(r / i), r % i]).map(function (t, e) {
                          return e ? 8 * t : t;
                        }),
                        2
                      ),
                      o = a[0],
                      h = a[1],
                      d = new Uint8Array(n + f + 8);
                    d.set(new Uint8Array(e), 0);
                    var s = new DataView(d.buffer);
                    return (
                      s.setUint8(n, 128),
                      s.setUint32(n + f, h, !0),
                      s.setUint32(n + f + 4, o, !0),
                      d.buffer
                    );
                  },
                },
                  ...
                  value: function (e) {
                    for (
                      var r = t.pad(e),
                        ...
                        o = r.byteLength / 64,
                        h = new Array(o).fill(void 0).map(function (t, e) {
                          return function (t) {
                            return new DataView(r, 64 * e, 64).getUint32(
                              4 * t,
                              !0
                            );
                          };
                      ...
                      var S = t.add_modulo32(d[1], l, g);
                      (d[1] = t.add_modulo32(d[2], b, M)),
                        (d[2] = t.add_modulo32(d[3], p, m)),
                        (d[3] = t.add_modulo32(d[4], u, v)),
                        (d[4] = t.add_modulo32(d[0], c, y)),
                        (d[0] = S);
                    }
      ...
      3550: function (t, e, r) {
        !(function (t, e) {
          ...
          function d(t, e, r, n) {
            for (
              var f = 0, a = 0, o = Math.min(t.length, r), h = e;
              h < o;
              h++
            ) {
              var d = t.charCodeAt(h) - 48;
              (f *= n),
          ...
          if (
            ...
            (f.prototype._parseBase = function (t, e, r) {
              ...
              if (0 !== a) {
                var u = 1;
                for (h = d(t, s, t.length, e), s = 0; s < a; s++) u *= e;
                this.imuln(u),
                  this.words[0] + h < 67108864
                    ? (this.words[0] += h)
                    : this._iaddn(h);
          ...
          function p(t, e, r) {
            ...
            for (var d = 1; d < i; d++) {
              for (
                var s = h >>> 26,
                  u = 67108863 & h,
                  c = Math.min(d, e.length - 1),
                  l = Math.max(0, d - t.length + 1);
                l <= c;
                l++
              ) {
                var b = (d - l) | 0;
                (s +=
                  ((a = (n = 0 | t.words[b]) * (f = 0 | e.words[l]) + u) /
                    67108864) |
                  0),
                  (u = 67108863 & a);
              }
            ...
            return 0 !== h ? (r.words[d] = 0 | h) : r.length--, r._strip();
          }
          (f.prototype.toString = function (t, e) {
            ...
            if (t === (0 | t) && t >= 2 && t <= 36) {
              ...
              for (u.negative = 0; !u.isZero(); ) {
                var p = u.modrn(s).toString(t);
                r = (u = u.idivn(s)).isZero() ? p + r : c[d - p.length] + p + r;
              }
            ...
            (f.prototype.isub = function (t) {
              ...
              for (var f = 0, a = 0; a < i.length; a++)
                (f = (e = (0 | r.words[a]) - (0 | i.words[a]) + f) >> 26),
                  (this.words[a] = 67108863 & e);
              for (; 0 !== f && a < r.length; a++)
                (f = (e = (0 | r.words[a]) + f) >> 26),
                  (this.words[a] = 67108863 & e);
          ...
          var m = function (t, e, r) {
            ...
            var mt =
              (((d + (i = Math.imul(u, C))) | 0) +
                ((8191 & (n = ((n = Math.imul(u, Z)) + Math.imul(c, C)) | 0)) <<
                  13)) |
              0;
            (d =
              ((((f = Math.imul(c, Z)) + (n >>> 13)) | 0) + (mt >>> 26)) | 0),
              (mt &= 67108863),
              (i = Math.imul(b, C)),
              (n = ((n = Math.imul(b, Z)) + Math.imul(p, C)) | 0),
              (f = Math.imul(p, Z));
            var vt =
              (((d + (i = (i + Math.imul(u, F)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, J)) | 0) + Math.imul(c, F)) | 0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, J)) | 0) + (n >>> 13)) | 0) +
                (vt >>> 26)) |
              0),
              (vt &= 67108863),
              (i = Math.imul(v, C)),
              (n = ((n = Math.imul(v, Z)) + Math.imul(y, C)) | 0),
              (f = Math.imul(y, Z)),
              (i = (i + Math.imul(b, F)) | 0),
              (n = ((n = (n + Math.imul(b, J)) | 0) + Math.imul(p, F)) | 0),
              (f = (f + Math.imul(p, J)) | 0);
            var yt =
              (((d + (i = (i + Math.imul(u, V)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, W)) | 0) + Math.imul(c, V)) | 0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, W)) | 0) + (n >>> 13)) | 0) +
                (yt >>> 26)) |
              0),
              (yt &= 67108863),
              (i = Math.imul(M, C)),
              (n = ((n = Math.imul(M, Z)) + Math.imul(w, C)) | 0),
              (f = Math.imul(w, Z)),
              (i = (i + Math.imul(v, F)) | 0),
              (n = ((n = (n + Math.imul(v, J)) | 0) + Math.imul(y, F)) | 0),
              (f = (f + Math.imul(y, J)) | 0),
              (i = (i + Math.imul(b, V)) | 0),
              (n = ((n = (n + Math.imul(b, W)) | 0) + Math.imul(p, V)) | 0),
              (f = (f + Math.imul(p, W)) | 0);
            var gt =
              (((d + (i = (i + Math.imul(u, Y)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, G)) | 0) + Math.imul(c, Y)) | 0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, G)) | 0) + (n >>> 13)) | 0) +
                (gt >>> 26)) |
              0),
              (gt &= 67108863),
              (i = Math.imul(S, C)),
              (n = ((n = Math.imul(S, Z)) + Math.imul(A, C)) | 0),
              (f = Math.imul(A, Z)),
              (i = (i + Math.imul(M, F)) | 0),
              (n = ((n = (n + Math.imul(M, J)) | 0) + Math.imul(w, F)) | 0),
              (f = (f + Math.imul(w, J)) | 0),
              (i = (i + Math.imul(v, V)) | 0),
              (n = ((n = (n + Math.imul(v, W)) | 0) + Math.imul(y, V)) | 0),
              (f = (f + Math.imul(y, W)) | 0),
              (i = (i + Math.imul(b, Y)) | 0),
            ...
            var Mt =
              (((d + (i = (i + Math.imul(u, $)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, tt)) | 0) + Math.imul(c, $)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, tt)) | 0) + (n >>> 13)) | 0) +
                (Mt >>> 26)) |
              0),
              (Mt &= 67108863),
              (i = Math.imul(I, C)),
              (n = ((n = Math.imul(I, Z)) + Math.imul(k, C)) | 0),
              (f = Math.imul(k, Z)),
              (i = (i + Math.imul(S, F)) | 0),
              (n = ((n = (n + Math.imul(S, J)) | 0) + Math.imul(A, F)) | 0),
              (f = (f + Math.imul(A, J)) | 0),
              (i = (i + Math.imul(M, V)) | 0),
              (n = ((n = (n + Math.imul(M, W)) | 0) + Math.imul(w, V)) | 0),
              (f = (f + Math.imul(w, W)) | 0),
              (i = (i + Math.imul(v, Y)) | 0),
              (n = ((n = (n + Math.imul(v, G)) | 0) + Math.imul(y, Y)) | 0),
              (f = (f + Math.imul(y, G)) | 0),
              (i = (i + Math.imul(b, $)) | 0),
              (n = ((n = (n + Math.imul(b, tt)) | 0) + Math.imul(p, $)) | 0),
              (f = (f + Math.imul(p, tt)) | 0);
            var wt =
              (((d + (i = (i + Math.imul(u, rt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, it)) | 0) + Math.imul(c, rt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, it)) | 0) + (n >>> 13)) | 0) +
                (wt >>> 26)) |
              0),
              (wt &= 67108863),
              (i = Math.imul(P, C)),
              (n = ((n = Math.imul(P, Z)) + Math.imul(R, C)) | 0),
              (f = Math.imul(R, Z)),
              (i = (i + Math.imul(I, F)) | 0),
              (n = ((n = (n + Math.imul(I, J)) | 0) + Math.imul(k, F)) | 0),
              (f = (f + Math.imul(k, J)) | 0),
              (i = (i + Math.imul(S, V)) | 0),
              (n = ((n = (n + Math.imul(S, W)) | 0) + Math.imul(A, V)) | 0),
              (f = (f + Math.imul(A, W)) | 0),
              (i = (i + Math.imul(M, Y)) | 0),
              (n = ((n = (n + Math.imul(M, G)) | 0) + Math.imul(w, Y)) | 0),
              (f = (f + Math.imul(w, G)) | 0),
              (i = (i + Math.imul(v, $)) | 0),
              (n = ((n = (n + Math.imul(v, tt)) | 0) + Math.imul(y, $)) | 0),
              (f = (f + Math.imul(y, tt)) | 0),
              (i = (i + Math.imul(b, rt)) | 0),
              (n = ((n = (n + Math.imul(b, it)) | 0) + Math.imul(p, rt)) | 0),
              (f = (f + Math.imul(p, it)) | 0);
            var _t =
              (((d + (i = (i + Math.imul(u, ft)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, at)) | 0) + Math.imul(c, ft)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, at)) | 0) + (n >>> 13)) | 0) +
                (_t >>> 26)) |
              0),
              (_t &= 67108863),
              (i = Math.imul(E, C)),
              (n = ((n = Math.imul(E, Z)) + Math.imul(K, C)) | 0),
              (f = Math.imul(K, Z)),
              (i = (i + Math.imul(P, F)) | 0),
              (n = ((n = (n + Math.imul(P, J)) | 0) + Math.imul(R, F)) | 0),
              (f = (f + Math.imul(R, J)) | 0),
              (i = (i + Math.imul(I, V)) | 0),
              (n = ((n = (n + Math.imul(I, W)) | 0) + Math.imul(k, V)) | 0),
              (f = (f + Math.imul(k, W)) | 0),
              (i = (i + Math.imul(S, Y)) | 0),
              (n = ((n = (n + Math.imul(S, G)) | 0) + Math.imul(A, Y)) | 0),
              (f = (f + Math.imul(A, G)) | 0),
              (i = (i + Math.imul(M, $)) | 0),
              (n = ((n = (n + Math.imul(M, tt)) | 0) + Math.imul(w, $)) | 0),
              (f = (f + Math.imul(w, tt)) | 0),
              (i = (i + Math.imul(v, rt)) | 0),
              (n = ((n = (n + Math.imul(v, it)) | 0) + Math.imul(y, rt)) | 0),
              (f = (f + Math.imul(y, it)) | 0),
              (i = (i + Math.imul(b, ft)) | 0),
              (n = ((n = (n + Math.imul(b, at)) | 0) + Math.imul(p, ft)) | 0),
              (f = (f + Math.imul(p, at)) | 0);
            var St =
              (((d + (i = (i + Math.imul(u, ht)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, dt)) | 0) + Math.imul(c, ht)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, dt)) | 0) + (n >>> 13)) | 0) +
                (St >>> 26)) |
              0),
              (St &= 67108863),
              (i = Math.imul(T, C)),
              (n = ((n = Math.imul(T, Z)) + Math.imul(N, C)) | 0),
              (f = Math.imul(N, Z)),
              (i = (i + Math.imul(E, F)) | 0),
              (n = ((n = (n + Math.imul(E, J)) | 0) + Math.imul(K, F)) | 0),
              (f = (f + Math.imul(K, J)) | 0),
              (i = (i + Math.imul(P, V)) | 0),
              (n = ((n = (n + Math.imul(P, W)) | 0) + Math.imul(R, V)) | 0),
              (f = (f + Math.imul(R, W)) | 0),
              (i = (i + Math.imul(I, Y)) | 0),
              (n = ((n = (n + Math.imul(I, G)) | 0) + Math.imul(k, Y)) | 0),
              (f = (f + Math.imul(k, G)) | 0),
              (i = (i + Math.imul(S, $)) | 0),
              (n = ((n = (n + Math.imul(S, tt)) | 0) + Math.imul(A, $)) | 0),
              (f = (f + Math.imul(A, tt)) | 0),
              (i = (i + Math.imul(M, rt)) | 0),
              (n = ((n = (n + Math.imul(M, it)) | 0) + Math.imul(w, rt)) | 0),
              (f = (f + Math.imul(w, it)) | 0),
              (i = (i + Math.imul(v, ft)) | 0),
              (n = ((n = (n + Math.imul(v, at)) | 0) + Math.imul(y, ft)) | 0),
              (f = (f + Math.imul(y, at)) | 0),
              (i = (i + Math.imul(b, ht)) | 0),
              (n = ((n = (n + Math.imul(b, dt)) | 0) + Math.imul(p, ht)) | 0),
              (f = (f + Math.imul(p, dt)) | 0);
            var At =
              (((d + (i = (i + Math.imul(u, ut)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, ct)) | 0) + Math.imul(c, ut)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, ct)) | 0) + (n >>> 13)) | 0) +
                (At >>> 26)) |
              0),
              (At &= 67108863),
              (i = Math.imul(O, C)),
              (n = ((n = Math.imul(O, Z)) + Math.imul(j, C)) | 0),
              (f = Math.imul(j, Z)),
              (i = (i + Math.imul(T, F)) | 0),
              (n = ((n = (n + Math.imul(T, J)) | 0) + Math.imul(N, F)) | 0),
              (f = (f + Math.imul(N, J)) | 0),
              (i = (i + Math.imul(E, V)) | 0),
              (n = ((n = (n + Math.imul(E, W)) | 0) + Math.imul(K, V)) | 0),
              (f = (f + Math.imul(K, W)) | 0),
              (i = (i + Math.imul(P, Y)) | 0),
              (n = ((n = (n + Math.imul(P, G)) | 0) + Math.imul(R, Y)) | 0),
              (f = (f + Math.imul(R, G)) | 0),
              (i = (i + Math.imul(I, $)) | 0),
              (n = ((n = (n + Math.imul(I, tt)) | 0) + Math.imul(k, $)) | 0),
              (f = (f + Math.imul(k, tt)) | 0),
              (i = (i + Math.imul(S, rt)) | 0),
              (n = ((n = (n + Math.imul(S, it)) | 0) + Math.imul(A, rt)) | 0),
              (f = (f + Math.imul(A, it)) | 0),
              (i = (i + Math.imul(M, ft)) | 0),
              (n = ((n = (n + Math.imul(M, at)) | 0) + Math.imul(w, ft)) | 0),
              (f = (f + Math.imul(w, at)) | 0),
              (i = (i + Math.imul(v, ht)) | 0),
              (n = ((n = (n + Math.imul(v, dt)) | 0) + Math.imul(y, ht)) | 0),
              (f = (f + Math.imul(y, dt)) | 0),
              (i = (i + Math.imul(b, ut)) | 0),
              (n = ((n = (n + Math.imul(b, ct)) | 0) + Math.imul(p, ut)) | 0),
              (f = (f + Math.imul(p, ct)) | 0);
            var xt =
              (((d + (i = (i + Math.imul(u, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(u, pt)) | 0) + Math.imul(c, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(c, pt)) | 0) + (n >>> 13)) | 0) +
                (xt >>> 26)) |
              0),
              (xt &= 67108863),
              (i = Math.imul(O, F)),
              (n = ((n = Math.imul(O, J)) + Math.imul(j, F)) | 0),
              (f = Math.imul(j, J)),
              (i = (i + Math.imul(T, V)) | 0),
              (n = ((n = (n + Math.imul(T, W)) | 0) + Math.imul(N, V)) | 0),
              (f = (f + Math.imul(N, W)) | 0),
              (i = (i + Math.imul(E, Y)) | 0),
              (n = ((n = (n + Math.imul(E, G)) | 0) + Math.imul(K, Y)) | 0),
              (f = (f + Math.imul(K, G)) | 0),
              (i = (i + Math.imul(P, $)) | 0),
              (n = ((n = (n + Math.imul(P, tt)) | 0) + Math.imul(R, $)) | 0),
              (f = (f + Math.imul(R, tt)) | 0),
              (i = (i + Math.imul(I, rt)) | 0),
              (n = ((n = (n + Math.imul(I, it)) | 0) + Math.imul(k, rt)) | 0),
              (f = (f + Math.imul(k, it)) | 0),
              (i = (i + Math.imul(S, ft)) | 0),
              (n = ((n = (n + Math.imul(S, at)) | 0) + Math.imul(A, ft)) | 0),
              (f = (f + Math.imul(A, at)) | 0),
              (i = (i + Math.imul(M, ht)) | 0),
              (n = ((n = (n + Math.imul(M, dt)) | 0) + Math.imul(w, ht)) | 0),
              (f = (f + Math.imul(w, dt)) | 0),
              (i = (i + Math.imul(v, ut)) | 0),
              (n = ((n = (n + Math.imul(v, ct)) | 0) + Math.imul(y, ut)) | 0),
              (f = (f + Math.imul(y, ct)) | 0);
            var It =
              (((d + (i = (i + Math.imul(b, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(b, pt)) | 0) + Math.imul(p, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(p, pt)) | 0) + (n >>> 13)) | 0) +
                (It >>> 26)) |
              0),
              (It &= 67108863),
              (i = Math.imul(O, V)),
              (n = ((n = Math.imul(O, W)) + Math.imul(j, V)) | 0),
              (f = Math.imul(j, W)),
              (i = (i + Math.imul(T, Y)) | 0),
              (n = ((n = (n + Math.imul(T, G)) | 0) + Math.imul(N, Y)) | 0),
              (f = (f + Math.imul(N, G)) | 0),
              (i = (i + Math.imul(E, $)) | 0),
              (n = ((n = (n + Math.imul(E, tt)) | 0) + Math.imul(K, $)) | 0),
              (f = (f + Math.imul(K, tt)) | 0),
              (i = (i + Math.imul(P, rt)) | 0),
              (n = ((n = (n + Math.imul(P, it)) | 0) + Math.imul(R, rt)) | 0),
              (f = (f + Math.imul(R, it)) | 0),
              (i = (i + Math.imul(I, ft)) | 0),
              (n = ((n = (n + Math.imul(I, at)) | 0) + Math.imul(k, ft)) | 0),
              (f = (f + Math.imul(k, at)) | 0),
              (i = (i + Math.imul(S, ht)) | 0),
              (n = ((n = (n + Math.imul(S, dt)) | 0) + Math.imul(A, ht)) | 0),
              (f = (f + Math.imul(A, dt)) | 0),
              (i = (i + Math.imul(M, ut)) | 0),
              (n = ((n = (n + Math.imul(M, ct)) | 0) + Math.imul(w, ut)) | 0),
              (f = (f + Math.imul(w, ct)) | 0);
            var kt =
              (((d + (i = (i + Math.imul(v, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(v, pt)) | 0) + Math.imul(y, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(y, pt)) | 0) + (n >>> 13)) | 0) +
                (kt >>> 26)) |
              0),
              (kt &= 67108863),
              (i = Math.imul(O, Y)),
              (n = ((n = Math.imul(O, G)) + Math.imul(j, Y)) | 0),
              (f = Math.imul(j, G)),
              (i = (i + Math.imul(T, $)) | 0),
              (n = ((n = (n + Math.imul(T, tt)) | 0) + Math.imul(N, $)) | 0),
              (f = (f + Math.imul(N, tt)) | 0),
              (i = (i + Math.imul(E, rt)) | 0),
              (n = ((n = (n + Math.imul(E, it)) | 0) + Math.imul(K, rt)) | 0),
              (f = (f + Math.imul(K, it)) | 0),
              (i = (i + Math.imul(P, ft)) | 0),
              (n = ((n = (n + Math.imul(P, at)) | 0) + Math.imul(R, ft)) | 0),
              (f = (f + Math.imul(R, at)) | 0),
              (i = (i + Math.imul(I, ht)) | 0),
              (n = ((n = (n + Math.imul(I, dt)) | 0) + Math.imul(k, ht)) | 0),
              (f = (f + Math.imul(k, dt)) | 0),
              (i = (i + Math.imul(S, ut)) | 0),
              (n = ((n = (n + Math.imul(S, ct)) | 0) + Math.imul(A, ut)) | 0),
              (f = (f + Math.imul(A, ct)) | 0);
            var zt =
              (((d + (i = (i + Math.imul(M, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(M, pt)) | 0) + Math.imul(w, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(w, pt)) | 0) + (n >>> 13)) | 0) +
                (zt >>> 26)) |
              0),
              (zt &= 67108863),
              (i = Math.imul(O, $)),
              (n = ((n = Math.imul(O, tt)) + Math.imul(j, $)) | 0),
              (f = Math.imul(j, tt)),
              (i = (i + Math.imul(T, rt)) | 0),
              (n = ((n = (n + Math.imul(T, it)) | 0) + Math.imul(N, rt)) | 0),
              (f = (f + Math.imul(N, it)) | 0),
              (i = (i + Math.imul(E, ft)) | 0),
              (n = ((n = (n + Math.imul(E, at)) | 0) + Math.imul(K, ft)) | 0),
              (f = (f + Math.imul(K, at)) | 0),
              (i = (i + Math.imul(P, ht)) | 0),
              (n = ((n = (n + Math.imul(P, dt)) | 0) + Math.imul(R, ht)) | 0),
              (f = (f + Math.imul(R, dt)) | 0),
              (i = (i + Math.imul(I, ut)) | 0),
              (n = ((n = (n + Math.imul(I, ct)) | 0) + Math.imul(k, ut)) | 0),
              (f = (f + Math.imul(k, ct)) | 0);
            var Pt =
              (((d + (i = (i + Math.imul(S, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(S, pt)) | 0) + Math.imul(A, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(A, pt)) | 0) + (n >>> 13)) | 0) +
                (Pt >>> 26)) |
              0),
              (Pt &= 67108863),
              (i = Math.imul(O, rt)),
              (n = ((n = Math.imul(O, it)) + Math.imul(j, rt)) | 0),
              (f = Math.imul(j, it)),
              (i = (i + Math.imul(T, ft)) | 0),
              (n = ((n = (n + Math.imul(T, at)) | 0) + Math.imul(N, ft)) | 0),
              (f = (f + Math.imul(N, at)) | 0),
              (i = (i + Math.imul(E, ht)) | 0),
              (n = ((n = (n + Math.imul(E, dt)) | 0) + Math.imul(K, ht)) | 0),
              (f = (f + Math.imul(K, dt)) | 0),
              (i = (i + Math.imul(P, ut)) | 0),
              (n = ((n = (n + Math.imul(P, ct)) | 0) + Math.imul(R, ut)) | 0),
              (f = (f + Math.imul(R, ct)) | 0);
            var Rt =
              (((d + (i = (i + Math.imul(I, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(I, pt)) | 0) + Math.imul(k, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(k, pt)) | 0) + (n >>> 13)) | 0) +
                (Rt >>> 26)) |
              0),
              (Rt &= 67108863),
              (i = Math.imul(O, ft)),
              (n = ((n = Math.imul(O, at)) + Math.imul(j, ft)) | 0),
              (f = Math.imul(j, at)),
              (i = (i + Math.imul(T, ht)) | 0),
              (n = ((n = (n + Math.imul(T, dt)) | 0) + Math.imul(N, ht)) | 0),
              (f = (f + Math.imul(N, dt)) | 0),
              (i = (i + Math.imul(E, ut)) | 0),
              (n = ((n = (n + Math.imul(E, ct)) | 0) + Math.imul(K, ut)) | 0),
              (f = (f + Math.imul(K, ct)) | 0);
            var qt =
              (((d + (i = (i + Math.imul(P, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(P, pt)) | 0) + Math.imul(R, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(R, pt)) | 0) + (n >>> 13)) | 0) +
                (qt >>> 26)) |
              0),
              (qt &= 67108863),
              (i = Math.imul(O, ht)),
              (n = ((n = Math.imul(O, dt)) + Math.imul(j, ht)) | 0),
              (f = Math.imul(j, dt)),
              (i = (i + Math.imul(T, ut)) | 0),
              (n = ((n = (n + Math.imul(T, ct)) | 0) + Math.imul(N, ut)) | 0),
              (f = (f + Math.imul(N, ct)) | 0);
            var Et =
              (((d + (i = (i + Math.imul(E, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(E, pt)) | 0) + Math.imul(K, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ...
              (Et &= 67108863),
              (i = Math.imul(O, ut)),
              (n = ((n = Math.imul(O, ct)) + Math.imul(j, ut)) | 0),
              (f = Math.imul(j, ct));
            var Kt =
              (((d + (i = (i + Math.imul(T, bt)) | 0)) | 0) +
                ((8191 &
                  (n =
                    ((n = (n + Math.imul(T, pt)) | 0) + Math.imul(N, bt)) |
                    0)) <<
                  13)) |
              0;
            (d =
              ((((f = (f + Math.imul(N, pt)) | 0) + (n >>> 13)) | 0) +
                (Kt >>> 26)) |
              0),
              (Kt &= 67108863);
            var Bt =
              (((d + (i = Math.imul(O, bt))) | 0) +
                ((8191 &
                  (n = ((n = Math.imul(O, pt)) + Math.imul(j, bt)) | 0)) <<
                  13)) |
              0;
            return (
              (d =
                ((((f = Math.imul(j, pt)) + (n >>> 13)) | 0) + (Bt >>> 26)) |
                0),
              (Bt &= 67108863),
              (h[0] = mt),
              (h[1] = vt),
          ...
          function v(t, e, r) {
            ...
            for (var i = 0, n = 0, f = 0; f < r.length - 1; f++) {
              ...
              for (
                ...
                var s = f - d,
                  u = (0 | t.words[s]) * (0 | e.words[d]),
                  c = 67108863 & u;
                (o = 67108863 & (c = (c + o) | 0)),
                  (n +=
                    (a =
                      ((a = (a + ((u / 67108864) | 0)) | 0) + (c >>> 26)) |
                      0) >>> 26),
                  (a &= 67108863);
              }
              (r.words[f] = o), (i = a), (a = n);
          ...
          Math.imul || (m = p),
            ...
            (g.prototype.permute = function (t, e, r, i, n, f) {
              for (var a = 0; a < f; a++) (i[a] = e[t[a]]), (n[a] = r[t[a]]);
            }),
            (g.prototype.transform = function (t, e, r, i, n, f) {
            ...
            (g.prototype.mulp = function (t, e, r) {
              ...
              (c.length = i),
                ...
                this.convert13b(e.words, e.length, d, i),
                this.transform(a, f, o, h, i, n),
                this.transform(d, f, s, u, i, n);
              for (var l = 0; l < i; l++) {
                var b = o[l] * s[l] - h[l] * u[l];
                (h[l] = o[l] * u[l] + h[l] * s[l]), (o[l] = b);
              }
              return (
                this.conjugate(o, h, i),
                this.transform(o, h, c, f, i, n),
                this.conjugate(c, f, i),
            ...
            (f.prototype.iushrn = function (t, e, r) {
              ...
              if (((n -= a), (n = Math.max(0, n)), h)) {
                for (var d = 0; d < a; d++) h.words[d] = this.words[d];
                h.length = a;
              }
              if (0 === a);
              ...
              var s = 0;
              for (d = this.length - 1; d >= 0 && (0 !== s || d >= n); d--) {
                var u = 0 | this.words[d];
                (this.words[d] = (s << (26 - f)) | (u >>> f)), (s = u & o);
              }
              return (
                h && 0 !== s && (h.words[h.length++] = s),
            ...
            (f.prototype._ishlnsubmul = function (t, e, r) {
              ...
              for (n = 0; n < t.length; n++) {
                ...
                var h = (0 | t.words[n]) * e;
                (o = ((f -= 67108863 & h) >> 26) - ((h / 67108864) | 0)),
            ...
            (f.prototype._wordDiv = function (t, e) {
              ...
              var o,
                h = i.length - n.length;
              if ("mod" !== e) {
                ((o = new f(null)).length = h + 1),
                  (o.words = new Array(o.length));
                for (var d = 0; d < o.length; d++) o.words[d] = 0;
              }
              var s = i.clone()._ishlnsubmul(n, 1, h);
              0 === s.negative && ((i = s), o && (o.words[h] = 1));
              for (var u = h - 1; u >= 0; u--) {
                var c =
                  67108864 * (0 | i.words[n.length + u]) +
                  (0 | i.words[n.length + u - 1]);
                for (
                  c = Math.min((c / a) | 0, 67108863), i._ishlnsubmul(n, c, u);
                  0 !== i.negative;
            ...
            (f.prototype.egcd = function (t) {
              ...
              for (
                ...
                e.iushrn(1), r.iushrn(1), ++d;
              for (var s = r.clone(), u = e.clone(); !e.isZero(); ) {
                for (
                  var c = 0, l = 1;
                  0 == (e.words[0] & l) && c < 26;
                  ++c, l <<= 1
                ...
                if (c > 0)
                  for (e.iushrn(c); c-- > 0; )
                    (n.isOdd() || a.isOdd()) && (n.iadd(s), a.isub(u)),
                      n.iushrn(1),
                      a.iushrn(1);
                for (
                  var b = 0, p = 1;
                ...
                if (b > 0)
                  for (r.iushrn(b); b-- > 0; )
                    (o.isOdd() || h.isOdd()) && (o.iadd(s), h.isub(u)),
                      o.iushrn(1),
                      h.iushrn(1);
                e.cmp(r) >= 0
                  ? (e.isub(r), n.isub(o), a.isub(h))
                  : (r.isub(e), o.isub(n), h.isub(a));
              }
              return { a: o, b: h, gcd: r.iushln(d) };
            }),
            (f.prototype._invmp = function (t) {
              ...
              e = 0 !== e.negative ? e.umod(t) : e.clone();
              for (
                var n, a = new f(1), o = new f(0), h = r.clone();
          ...
          (w.prototype._tmp = function () {
            ...
            (I.prototype.sqrt = function (t) {
              ...
              var o = new f(1).toRed(this),
                ...
                s = this.m.bitLength();
              for (
                s = new f(2 * s * s).toRed(this);
                0 !== this.pow(s, d).cmp(h);
            ...
            (I.prototype.pow = function (t, e) {
              ...
              for (0 === h && (h = 26), i = e.length - 1; i >= 0; i--) {
                for (var d = e.words[i], s = h - 1; s >= 0; s--) {
                  var u = (d >> s) & 1;
                  n !== r[0] && (n = this.sqr(n)),
                    0 !== u || 0 !== a
                      ? ((a <<= 1),
        ...
        (t.exports = h),
          ...
          (h.prototype._fixedNafMul = function (t, e) {
            ...
            for (a = 0; a < i.length; a += r.step) {
              h = 0;
              for (var s = a + r.step - 1; s >= a; s--) h = (h << 1) + i[s];
              d.push(h);
            }
            for (
              ...
              for (a = 0; a < d.length; a++)
                (h = d[a]) === l
                  ...
                  : h === -l && (c = c.mixedAdd(r.points[a].neg()));
              u = u.add(c);
            }
            return u.toP();
          }),
          (h.prototype._wnafMul = function (t, e) {
            ...
            for (
              ...
              for (var s = 0; d >= 0 && 0 === a[d]; d--) s++;
              if ((d >= 0 && s++, (h = h.dblp(s)), d < 0)) break;
              var u = a[d];
              o(0 !== u),
                (h =
                  "affine" === t.type
          ...
          (h.prototype._wnafMulAdd = function (t, e, r, i, n) {
            var o,
              ...
              l = 0;
            for (o = 0; o < i; o++) {
              var b = (d = e[o])._getNAFPoints(t);
              (s[o] = b.wnd), (u[o] = b.points);
            }
            for (o = i - 1; o >= 1; o -= 2) {
              var p = o - 1,
                m = o;
              if (1 === s[p] && 1 === s[m]) {
                var v = [e[p], null, null, e[m]];
                0 === e[p].y.cmp(e[m].y)
                  ? ((v[1] = e[p].add(e[m])),
                    (v[2] = e[p].toJ().mixedAdd(e[m].neg())))
                  : 0 === e[p].y.cmp(e[m].y.redNeg())
                  ? ((v[1] = e[p].toJ().mixedAdd(e[m])),
                    (v[2] = e[p].add(e[m].neg())))
                  : ((v[1] = e[p].toJ().mixedAdd(e[m])),
                    (v[2] = e[p].toJ().mixedAdd(e[m].neg())));
                ...
                (c[p] = f(r[p], s[p], this._bitLength)),
                  (c[m] = f(r[m], s[m], this._bitLength)),
      ...
      1138: (t, e, r) => {
        ...
        f(h, a),
          ...
          (h.prototype.pointFromX = function (t, e) {
            ...
            return (
              ((e && !h) || (!e && h)) && (o = o.redNeg()), this.point(t, o)
            );
          }),
          (h.prototype.pointFromY = function (t, e) {
            ...
            if (0 !== o.redSqr().redSub(a).cmp(this.zero))
              throw new Error("invalid point");
            return (
              o.fromRed().isOdd() !== e && (o = o.redNeg()), this.point(o, t)
            );
          }),
          ...
          (h.prototype.point = function (t, e, r, i) {
            return new d(this, t, e, r, i);
          }),
          (d.fromJSON = function (t, e) {
            return new d(t, e[0], e[1], e[2]);
          }),
          ...
          (d.prototype._extDbl = function () {
            ...
            var i = this.curve._mulA(t),
              ...
              s = n.redMul(o),
              u = a.redMul(f);
            return this.curve.point(h, d, u, s);
          }),
          (d.prototype._projDbl = function () {
            ...
            if (this.curve.twisted) {
              var d = (i = this.curve._mulA(o)).redAdd(h);
              this.zOne
                ? ((t = a.redSub(o).redSub(h).redMul(d.redSub(this.curve.two))),
                  (e = d.redMul(i.redSub(h))),
                  (r = d.redSqr().redSub(d).redSub(d)))
                : ((n = this.z.redSqr()),
                  (f = d.redSub(n).redISub(n)),
                  (t = a.redSub(o).redISub(h).redMul(f)),
                  (e = d.redMul(i.redSub(h))),
                  (r = d.redMul(f)));
            } else
              (i = o.redAdd(h)),
                ...
                (t = this.curve._mulC(a.redISub(i)).redMul(f)),
                (e = this.curve._mulC(i).redMul(o.redISub(h))),
                (r = i.redMul(f));
          ...
          (d.prototype._extAdd = function (t) {
            var e = this.y.redSub(this.x).redMul(t.y.redSub(t.x)),
              ...
              u = f.redMul(h),
              c = a.redMul(o);
            return this.curve.point(d, s, c, u);
          }),
          (d.prototype._projAdd = function (t) {
            var e,
              r,
              i = this.z.redMul(t.z),
              n = i.redSqr(),
              ...
              s = this.x
                ...
                .redISub(f)
                .redISub(a),
              u = i.redMul(h).redMul(s);
            return (
              this.curve.twisted
                ? ((e = i.redMul(d).redMul(a.redSub(this.curve._mulA(f)))),
                  (r = h.redMul(d)))
                : ((e = i.redMul(d).redMul(a.redSub(f))),
                  (r = this.curve._mulC(h).redMul(d))),
          ...
          (d.prototype.mulAdd = function (t, e, r) {
            return this.curve._wnafMulAdd(1, [this, e], [t, r], 2, !1);
          }),
          (d.prototype.jmulAdd = function (t, e, r) {
        ...
        n(o, f),
          ...
          (h.prototype.diffAdd = function (t, e) {
            var r = this.x.redAdd(this.z),
              ...
              h = e.x.redMul(f.redISub(a).redSqr());
        ...
        f(h, a),
          ...
          (h.prototype._getEndoBasis = function (t) {
            for (
              ...
              var g = l.div(c);
              (d = l.sub(g.mul(c))), (s = m.sub(g.mul(b)));
              var M = v.sub(g.mul(p));
              if (!i && d.cmp(u) < 0)
                (e = h.neg()), (r = b), (i = d.neg()), (f = s);
              else if (i && 2 == ++y) break;
              (h = d), (l = c), (c = d), (m = b), (b = s), (v = p), (p = M);
            }
            (a = d.neg()), (o = s);
          ...
          (h.prototype._endoSplit = function (t) {
            var e = this.endo.basis,
              ...
              h = n.mul(r.b),
              d = f.mul(i.b);
            return { k1: t.sub(a).sub(o), k2: h.add(d).neg() };
          }),
          (h.prototype.pointFromX = function (t, e) {
            (t = new n(t, 16)).red || (t = t.toRed(this.red));
            var r = t
          ...
          (h.prototype._endoWnafMulAdd = function (t, e, r) {
            for (
              ...
              a.k1.negative && (a.k1.ineg(), (o = o.neg(!0))),
                a.k2.negative && (a.k2.ineg(), (h = h.neg(!0))),
                (i[2 * f] = o),
                (i[2 * f + 1] = h),
                (n[2 * f] = a.k1),
                (n[2 * f + 1] = a.k2);
            ...
            for (
              var d = this._wnafMulAdd(1, i, n, 2 * f, r), s = 0;
              s < 2 * f;
              s++
            )
              (i[s] = null), (n[s] = null);
          ...
          (s.prototype.add = function (t) {
            ...
            var d = o.redSqr(),
              s = d.redMul(o),
              u = i.redMul(d),
              c = h.redSqr().redIAdd(s).redISub(u).redISub(u),
              l = h.redMul(u.redISub(c)).redISub(f.redMul(s)),
          ...
          (s.prototype.mixedAdd = function (t) {
            ...
            var h = a.redSqr(),
              d = h.redMul(a),
              s = r.redMul(h),
              u = o.redSqr().redIAdd(d).redISub(s).redISub(s),
              c = o.redMul(s.redISub(u)).redISub(n.redMul(d)),
              l = this.z.redMul(a);
          ...
          (s.prototype.dblp = function (t) {
            ...
            for (e = 0; e < t; e++) {
              var s = f.redSqr(),
                u = d.redSqr(),
                c = u.redSqr(),
                l = s.redAdd(s).redIAdd(s).redIAdd(i.redMul(h)),
                b = f.redMul(u),
              ...
              var y = d.redMul(o);
              e + 1 < t && (h = h.redMul(c)), (f = p), (o = y), (d = v);
            }
          ...
          (s.prototype._zeroDbl = function () {
            ...
            if (this.zOne) {
              ...
              (d = (d = d.redIAdd(d)).redIAdd(d)),
                (t = h),
                (e = o.redMul(a.redISub(h)).redISub(d)),
                (r = this.y.redAdd(this.y));
            } else {
              var s = this.x.redSqr(),
                u = this.y.redSqr(),
                c = u.redSqr(),
                l = this.x.redAdd(u).redSqr().redISub(s).redISub(c);
              l = l.redIAdd(l);
              var b = s.redAdd(s).redIAdd(s),
                p = b.redSqr(),
                m = c.redIAdd(c);
          ...
          (s.prototype._threeDbl = function () {
            ...
            if (this.zOne) {
              ...
              var s = this.z.redSqr(),
                u = this.y.redSqr(),
                c = this.x.redMul(u),
                l = this.x.redSub(s).redMul(this.x.redAdd(s));
              l = l.redAdd(l).redIAdd(l);
              var b = c.redIAdd(c),
                p = (b = b.redIAdd(b)).redAdd(b);
              (t = l.redSqr().redISub(p)),
                (r = this.y.redAdd(this.z).redSqr().redISub(u).redISub(s));
              var m = u.redSqr();
          ...
          (s.prototype._dbl = function () {
            var t = this.curve.a,
              ...
              h = e.redAdd(e),
              d = (h = h.redIAdd(h)).redMul(a),
              s = o.redSqr().redISub(d.redAdd(d)),
              u = d.redISub(s),
              c = a.redSqr();
            c = (c = (c = c.redIAdd(c)).redIAdd(c)).redIAdd(c);
            var l = o.redMul(u).redISub(c),
              b = r.redAdd(r).redMul(i);
            return this.curve.jpoint(s, l, b);
          }),
          (s.prototype.trpl = function () {
            ...
            var d = n.redIAdd(a).redSqr().redISub(f).redISub(o).redISub(h),
              s = e.redMul(d);
            s = (s = s.redIAdd(s)).redIAdd(s);
            var u = this.x.redMul(o).redISub(s);
            u = (u = u.redIAdd(u)).redIAdd(u);
            var c = this.y.redMul(d.redMul(h.redISub(d)).redISub(a.redMul(o)));
            c = (c = (c = c.redIAdd(c)).redIAdd(c)).redIAdd(c);
      ...
      7954: (t, e, r) => {
        ...
        (t.exports = u),
          ...
          (u.prototype.keyFromPrivate = function (t, e) {
            return d.fromPrivate(this, t, e);
          }),
          (u.prototype.keyFromPublic = function (t, e) {
            return d.fromPublic(this, t, e);
          }),
          ...
          (u.prototype.sign = function (t, e, r, f) {
            ...
            for (
              ...
              var l = f.k ? f.k(c) : new i(d.generate(this.n.byteLength()));
              if (
          ...
          (u.prototype.verify = function (t, e, r, n) {
            ...
            var o,
              ...
              u = h.mul(f).umod(this.n);
            return this.curve._maxwellTrick
              ? !(o = this.g.jmulAdd(d, r.getPublic(), u)).isInfinity() &&
                  o.eqXToP(f)
              : !(o = this.g.mulAdd(d, r.getPublic(), u)).isInfinity() &&
          ...
          (u.prototype.getKeyRecoveryParam = function (t, e, r, i) {
            if (null !== (e = new s(e, i)).recoveryParam)
      ...
      611: (t, e, r) => {
        ...
        (t.exports = a),
          (a.prototype._importDER = function (t, e) {
            ...
            var f = h(t, r);
            if (!1 === f) return !1;
            if (f + r.place !== t.length) return !1;
            if (2 !== t[r.place++]) return !1;
            var a = h(t, r);
            if (!1 === a) return !1;
            var d = t.slice(r.place, a + r.place);
          ...
          (a.prototype.toDER = function (t) {
            ...
            for (
              ...
              r = r.slice(1);
            var i = [2];
            s(i, e.length), (i = i.concat(e)).push(2), s(i, r.length);
            var f = i.concat(r),
              a = [48];
            return s(a, f.length), (a = a.concat(f)), n.encode(a, t);
          });
      },
      5980: (t, e, r) => {
        "use strict";
        ...
        (t.exports = s),
          (s.prototype.sign = function (t, e) {
            ...
            return this.makeSignature({ R: n, S: h, Rencoded: f });
          }),
          (s.prototype.verify = function (t, e, r) {
          ...
          (s.prototype.keyFromPublic = function (t) {
            return h.fromPublic(this, t);
          }),
          (s.prototype.keyFromSecret = function (t) {
            return h.fromSecret(this, t);
          }),
          (s.prototype.makeSignature = function (t) {
            return t instanceof d ? t : new d(this, t);
          }),
          (s.prototype.encodePoint = function (t) {
            var e = t.getY().toArray("le", this.encodingLength);
            return (
              (e[this.encodingLength - 1] |= t.getX().isOdd() ? 128 : 0), e
            );
          }),
          (s.prototype.decodePoint = function (t) {
          ...
          (s.prototype.encodeInt = function (t) {
            return t.toArray("le", this.encodingLength);
          }),
          (s.prototype.decodeInt = function (t) {
            return f.intFromLE(t);
          }),
          (s.prototype.isPoint = function (t) {
      ...
      3785: function (t, e, r) {
        !(function (t, e) {
          ...
          function l(t, e, r) {
            ...
            return 0 !== h ? (r.words[d] = 0 | h) : r.length--, r.strip();
          }
          (f.prototype.toString = function (t, e) {
            var r;
            if (((e = 0 | e || 1), 16 === (t = t || 10) || "hex" === t)) {
            ...
            if (t === (0 | t) && t >= 2 && t <= 36) {
              ...
              for (b.negative = 0; !b.isZero(); ) {
                ...
                r = (b = b.idivn(l)).isZero() ? p + r : s[d - p.length] + p + r;
              }
              for (this.isZero() && (r = "0" + r); r.length % e != 0; )
                r = "0" + r;
              return 0 !== this.negative && (r = "-" + r), r;
            ...
            (f.prototype.toArrayLike = function (t, e, r) {
              ...
              if (h) {
                for (o = 0; !s.isZero(); o++)
                  (a = s.andln(255)), s.iushrn(8), (d[o] = a);
                for (; o < f; o++) d[o] = 0;
              } else {
                for (o = 0; o < f - n; o++) d[o] = 0;
                for (o = 0; !s.isZero(); o++)
                  (a = s.andln(255)), s.iushrn(8), (d[f - o - 1] = a);
              }
              return d;
            }),
            Math.clz32
          ...
          Math.imul || (b = l),
            ...
            (m.prototype.permute = function (t, e, r, i, n, f) {
              for (var a = 0; a < f; a++) (i[a] = e[t[a]]), (n[a] = r[t[a]]);
            }),
            (m.prototype.transform = function (t, e, r, i, n, f) {
              this.permute(f, t, e, r, i, n);
              for (var a = 1; a < n; a <<= 1)
                for (
                  var o = a << 1,
        ...
        i.inherits(s, d),
          ...
          (s.prototype._update = function (t, e) {
            for (
              ...
              var A = a(f(h(r, u(S, i, n, d), t[b[S] + e], c(S)), m[S]), s);
              (r = s),
                (s = d),
                (d = f(n, 10)),
                (n = i),
                (i = A),
                (A = a(
                  f(h(y, u(79 - S, g, M, w), t[p[S] + e], l(S)), v[S]),
                  _
                )),
                (y = _),
                (_ = w),
            ...
            (A = o(this.h[1], n, w)),
              ...
              (this.h[2] = o(this.h[3], s, y)),
              (this.h[3] = o(this.h[4], r, g)),
              (this.h[4] = o(this.h[0], i, M)),
              (this.h[0] = A);
          }),
        ...
        i.inherits(c, s),
          ...
          (c.prototype._update = function (t, e) {
            ...
            for (i = 0; i < r.length; i++) {
              var b = ~~(i / 20),
                p = h(a(n, 5), d(b, f, s, c), l, r[i], u[b]);
              (l = c), (c = s), (s = a(f, 30)), (f = n), (n = p);
            }
            (this.h[0] = o(this.h[0], n)),
              (this.h[1] = o(this.h[1], f)),
              (this.h[2] = o(this.h[2], s)),
      ...
      9344: (t, e, r) => {
        ...
        i.inherits(y, m),
          ...
          (y.prototype._update = function (t, e) {
            for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
            for (; i < r.length; i++)
              r[i] = h(p(r[i - 2]), r[i - 7], b(r[i - 15]), r[i - 16]);
            var n = this.h[0],
              f = this.h[1],
              m = this.h[2],
              v = this.h[3],
            ...
            for (a(this.k.length === r.length), i = 0; i < r.length; i++) {
              var _ = d(w, l(y), s(y, g, M), this.k[i], r[i]),
                S = o(c(n), u(n, f, m));
              (w = M),
                (M = g),
                (g = y),
      ...
      5900: (t, e, r) => {
        ...
        function z(t, e) {
          var r = o(t, e, 1) ^ o(t, e, 8) ^ d(t, e, 7);
          return r < 0 && (r += 4294967296), r;
        }
        function P(t, e) {
          var r = o(t, e, 19) ^ o(e, t, 29) ^ d(t, e, 6);
          return r < 0 && (r += 4294967296), r;
        }
        i.inherits(g, v),
          (t.exports = g),
          ...
          (g.prototype._prepareBlock = function (t, e) {
            ...
            for (; i < r.length; i += 2) {
              var n =
                ...
                c = r[i - 32],
                p = r[i - 31];
              (r[i] = l(n, f, o, d, s, u, c, p)),
                (r[i + 1] = b(n, f, o, d, s, u, c, p));
            }
            var m, v, y;
          }),
          (g.prototype._update = function (t, e) {
            ...
            for (var N = 0; N < o.length; N += 2) {
              var L = B,
                ...
                j =
                  ((n = void 0),
                  (n = a((r = z), (i = P), 14) ^ a(r, i, 18) ^ a(i, r, 9)) <
                    0 && (n += 4294967296),
                  n),
                D = I(z, P),
                C = M(z, 0, R, 0, E),
                ...
                J = o[N],
                H = o[N + 1],
                V = p(L, O, j, D, C, Z, U, F, J, H),
                W = m(L, O, j, D, C, Z, U, F, J, H);
              (L = A(h, d)),
                (O = x(h, d)),
                (j = _(h, 0, l, 0, v)),
                (D = S(0, d, 0, b, 0, y));
        ...
        (e.inherits = n),
          ...
          (e.sum64_4_hi = function (t, e, r, i, n, f, a, o) {
            ...
            return (
              (h += (d = (d + i) >>> 0) < e ? 1 : 0),
              (h += (d = (d + f) >>> 0) < f ? 1 : 0),
              (t + r + n + a + (h += (d = (d + o) >>> 0) < o ? 1 : 0)) >>> 0
            );
          }),
          (e.sum64_4_lo = function (t, e, r, i, n, f, a, o) {
            return (e + i + f + o) >>> 0;
          }),
          (e.sum64_5_hi = function (t, e, r, i, n, f, a, o, h, d) {
            var s = 0,
              u = e;
            return (
              (s += (u = (u + i) >>> 0) < e ? 1 : 0),
              (s += (u = (u + f) >>> 0) < f ? 1 : 0),
              (s += (u = (u + o) >>> 0) < o ? 1 : 0),
              (t + r + n + a + h + (s += (u = (u + d) >>> 0) < d ? 1 : 0)) >>> 0
            );
          }),
          (e.sum64_5_lo = function (t, e, r, i, n, f, a, o, h, d) {
            return (e + i + f + o + d) >>> 0;
          }),
  ...
  function r(i) {
    ...
    var f = (e[i] = { id: i, loaded: !1, exports: {} });
    return t[i].call(f.exports, f, f.exports, r), (f.loaded = !0), f.exports;
  }
