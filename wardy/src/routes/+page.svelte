...
<svelte:head>
    <title>wardy Dapps</title>
</svelte:head>

<div class="container mx-auto min-h-screen px-20 pb-20 pt-20">
    <div class="flex justify-center">
        <div on:click={() => goto("https://twitter.com/degoo123")} class="avatar relative cursor-pointer mb-4">
    ...
    <div class="mb-10 text-center">
        <div class="text-4xl  animate__animated animate__fadeIn animate__delay-1s text-white font-bold ">
        Inery Task 5 by wardy
        </div>
    ...
    <div class="flex">
        <div class="flex flex-col flex-direction: row; justify-left items-left animate__animated animate__fadeIn animate__delay-2s" style="gap: 50px; margin-left: 10px;">
            <label for="modal-create" class="btn bg-white text-black-500 btn-outline" style="width: 100px; margin-right: 10px;">Create</label>
            <label for="modal-read" class="btn bg-white text-black-500 btn-outline" style="width: 100px; margin-right: 10px;">View</label>
            <label for="modal-update" class="btn bg-white text-black-500 btn-outline" style="width: 100px; margin-right: 10px;">Update</label>
            <label for="modal-destroy" class="btn bg-white text-black-500 btn-outline" style="width: 100px; margin-right: 10px;">Delete</label>
        </div>
...
<Modal modal_id="modal-create" modal_title="Build New Record on Inery" on:click={() => create()}>
    <div slot="body" class="flex flex-col gap-4">
        ...
        <input type="text" placeholder="wardy" class="input input-bordered w-full max-w-xs" disabled />
        <textarea bind:value={create_data} class="textarea textarea-bordered w-full" placeholder="Type the detailys"></textarea>
    </div>
</Modal>
