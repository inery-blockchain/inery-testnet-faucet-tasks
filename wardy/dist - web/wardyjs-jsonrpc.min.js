  ...
  var t = {
        ...
        e.JsonRpc = class {
          constructor(t, e) {
            void 0 === e && (e = {}),
              ...
              void 0 !== r.g && r.g.fetch
                ? (this.fetchBuiltin = r.g.fetch)
                : (this.fetchBuiltin = e.fetch || r(3300));
          }
          fetch(t, e, o = "POST") {
            return n(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                switch (i.label) {
                  case 0:
                    i.trys.push([0, 3, , 4]), (u = this.fetchBuiltin);
                    let c = { body: JSON.stringify(e), method: o };
                    if (this.endpoint.startsWith("https")) {
                      const t = r(9267);
                      c.agent = new t.Agent({ rejectUnauthorized: !1 });
                    }
                    return [4, u(this.endpoint + t, c)];
                  case 1:
                    return [4, (n = i.sent()).json()];
                  case 2:
                    if ((s = i.sent()).processed && s.processed.except)
                      throw new a.RpcError(s);
                    if (s.result && s.result.except) throw new a.RpcError(s);
                    return [3, 4];
                  case 3:
                    throw (((h = i.sent()).isFetchError = !0), h);
                  case 4:
                    if (!n.ok) throw new a.RpcError(s);
                    return [2, s];
                }
              });
            });
          }
          abi_bin_to_json(t, e, r) {
            return n(this, void 0, void 0, function () {
          ...
          get_accounts_by_authorizers(t, e) {
            return n(this, void 0, void 0, function () {
          ...
          get_activated_protocol_features(t) {
            var e = t.limit,
              r = void 0 === e ? 10 : e,
              ...
              return i(this, function (e) {
                switch (e.label) {
                  case 0:
                    return [
                      4,
                      this.fetch("/v1/chain/get_block_info", { block_num: t }),
                    ];
                  case 1:
                    return [2, e.sent()];
                }
              ...
              return i(this, function (e) {
                switch (e.label) {
                  case 0:
                    return [
                      4,
                      this.fetch("/v1/chain/get_raw_abi", { account_name: t }),
                    ];
                  case 1:
                    return [2, e.sent()];
                }
          ...
          get_scheduled_transactions(t, e, r) {
            return (
              void 0 === t && (t = !0),
              void 0 === e && (e = ""),
              void 0 === r && (r = 50),
          ...
          history_get_controlled_accounts(t) {
            return n(this, void 0, void 0, function () {
              return i(this, function (e) {
                switch (e.label) {
                  case 0:
      ...
      9637: function (t, e, r) {
        ...
        (e.isNegative = function (t) {
          ...
          (e.signedDecimalToBinary = function (t, r) {
            ...
            if (n) {
              if ((e.negate(i), !e.isNegative(i)))
                throw new Error("number is out of range");
            } else if (e.isNegative(i))
              throw new Error("number is out of range");
            return i;
          }),
          (e.binaryToDecimal = function (t, e) {
            void 0 === e && (e = 1);
            for (
              var r = Array(e).fill("0".charCodeAt(0)), o = t.length - 1;
              o >= 0;
              --o
            ) {
              for (var s = t[o], a = 0; a < r.length; ++a) {
                var u = ((r[a] - "0".charCodeAt(0)) << 8) + s;
                (r[a] = "0".charCodeAt(0) + (u % 10)), (s = (u / 10) | 0);
              }
              for (; s; )
                r.push("0".charCodeAt(0) + (s % 10)), (s = (s / 10) | 0);
            }
          ...
          (e.binaryToBase58 = function (t, e) {
            ...
            try {
              for (var l = o(t), d = l.next(); !d.done; d = l.next()) {
                for (var p = d.value, g = 0; g < c.length; ++g) {
                  var y = (f[c[g]] << 8) + p;
                  (c[g] = h.charCodeAt(y % 58)), (p = (y / 58) | 0);
                }
                for (; p; ) c.push(h.charCodeAt(p % 58)), (p = (p / 58) | 0);
              }
            } catch (t) {
              r = { error: t };
            } finally {
          ...
          (e.base64ToBinary = function (t) {
            ...
            for (var i = new Uint8Array(n), o = 0; o < r; ++o) {
              var s = l[t.charCodeAt(4 * o + 0)],
                a = l[t.charCodeAt(4 * o + 1)],
                u = l[t.charCodeAt(4 * o + 2)],
                h = l[t.charCodeAt(4 * o + 3)];
              (i[3 * o + 0] = (s << 2) | (a >> 4)),
                3 * o + 1 < n && (i[3 * o + 1] = ((15 & a) << 4) | (u >> 2)),
                3 * o + 2 < n && (i[3 * o + 2] = ((3 & u) << 6) | h);
            }
            return i;
          }),
          (function (t) {
        ...
        var d = function (t, e) {
          ...
          p = function (t, r, n, i) {
            var o = e.base58ToBinary(n ? n + 4 : 0, t),
              s = { type: r, data: new Uint8Array(o.buffer, 0, o.length - 4) },
              a = new Uint8Array(d(s.data, i));
            if (
              a[0] !== o[o.length - 4] ||
              a[1] !== o[o.length - 3] ||
              a[2] !== o[o.length - 2] ||
          ...
          g = function (t, r, n) {
            for (
              var i = new Uint8Array(d(t.data, r)),
                o = new Uint8Array(t.data.length + 4),
                s = 0;
              s < t.data.length;
              ++s
            )
              o[s] = t.data[s];
            for (s = 0; s < 4; ++s) o[s + t.data.length] = i[s];
        ...
        (e.stringToPublicKey = function (t) {
          ...
          if ("INE" === t.substr(0, 3)) {
            for (
              var r = e.base58ToBinary(e.publicKeyDataSize + 4, t.substr(3)),
                n = { type: s.k1, data: new Uint8Array(e.publicKeyDataSize) },
                i = 0;
          ...
          if ("PUB_K1_" === t.substr(0, 7))
            return p(t.substr(7), s.k1, e.publicKeyDataSize, "K1");
          if ("PUB_R1_" === t.substr(0, 7))
            return p(t.substr(7), s.r1, e.publicKeyDataSize, "R1");
          if ("PUB_WA_" === t.substr(0, 7))
            return p(t.substr(7), s.wa, 0, "WA");
          throw new Error("unrecognized public key format");
        }),
          (e.publicKeyToLegacyString = function (t) {
            if (t.type === s.k1 && t.data.length === e.publicKeyDataSize)
              return g(t, "", "INE");
            throw t.type === s.r1 || t.type === s.wa
          ...
          (e.publicKeyToString = function (t) {
            ...
            if (t.type === s.r1 && t.data.length === e.publicKeyDataSize)
              return g(t, "R1", "PUB_R1_");
            if (t.type === s.wa) return g(t, "WA", "PUB_WA_");
            throw new Error("unrecognized public key format");
          }),
          ...
          (e.stringToPrivateKey = function (t) {
            ...
            if ("PVT_R1_" === t.substr(0, 7))
              return p(t.substr(7), s.r1, e.privateKeyDataSize, "R1");
            if ("PVT_K1_" === t.substr(0, 7))
              return p(t.substr(7), s.k1, e.privateKeyDataSize, "K1");
            var r = e.base58ToBinary(e.privateKeyDataSize + 5, t),
              n = { type: s.k1, data: new Uint8Array(e.privateKeyDataSize) };
          ...
          (e.privateKeyToLegacyString = function (t) {
            if (t.type === s.k1 && t.data.length === e.privateKeyDataSize) {
              var r = [];
              r.push(128),
              ...
              for (
                var n = new Uint8Array(
                    a.sha256().update(a.sha256().update(r).digest()).digest()
                  ),
                  i = new Uint8Array(e.privateKeyDataSize + 5),
                  o = 0;
                o < r.length;
                o++
              )
          ...
          (e.privateKeyToString = function (t) {
            if (t.type === s.r1) return g(t, "R1", "PVT_R1_");
            if (t.type === s.k1) return g(t, "K1", "PVT_K1_");
          ...
          (e.stringToSignature = function (t) {
            ...
            if ("SIG_K1_" === t.substr(0, 7))
              return p(t.substr(7), s.k1, e.signatureDataSize, "K1");
            if ("SIG_R1_" === t.substr(0, 7))
              return p(t.substr(7), s.r1, e.signatureDataSize, "R1");
            if ("SIG_WA_" === t.substr(0, 7))
              return p(t.substr(7), s.wa, 0, "WA");
            throw new Error("unrecognized signature format");
          }),
          (e.signatureToString = function (t) {
            if (t.type === s.k1) return g(t, "K1", "SIG_K1_");
            if (t.type === s.r1) return g(t, "R1", "SIG_R1_");
            if (t.type === s.wa) return g(t, "WA", "SIG_WA_");
            throw new Error("unrecognized signature format");
          });
      },
      5921: function (t, e) {
          ...
          function e(r) {
            ...
            return (
              ...
              r.error.details[0].message
                ? ((n =
                    t.call(this, r.error.details[0].message) || this).details =
                    r.error.details)
                : r.processed &&
                  r.processed.except &&
                  r.processed.except.message
                ? ((n =
                    t.call(this, r.processed.except.message) || this).details =
                    r.processed.except)
                : r.result && r.result.except && r.result.except.message
                ? ((n = t.call(this, r.result.except.message) || this).details =
                    r.result.except)
                : (n = t.call(this, r.message) || this),
                  ...
                  value: function (e) {
                    var r,
                      ...
                      s = (function (t, e) {
                        ...
                        ((r = i),
                        (n = 536870912),
                        [Math.floor(r / n), r % n]).map(function (t, e) {
                          return e ? 8 * t : t;
                        }),
                        2
                      ),
                  ...
                  value: function (e) {
                    for (
                      var r = t.pad(e),
                        ...
                        a = r.byteLength / 64,
                        u = new Array(a).fill(void 0).map(function (t, e) {
                          return function (t) {
                      ...
                      var S = t.add_modulo32(h[1], d, _);
                      (h[1] = t.add_modulo32(h[2], p, m)),
                        (h[2] = t.add_modulo32(h[3], g, y)),
                        (h[3] = t.add_modulo32(h[4], f, b)),
                        (h[4] = t.add_modulo32(h[0], l, v)),
                        (h[0] = S);
                    }
                    var R = new ArrayBuffer(20),
                      T = new DataView(R);
                    return (
      ...
      8764: (t, e, r) => {
        ...
        function F(t, e, r) {
          if (Math.floor(t) !== t)
            throw (
              (H(t, r), new D.ERR_OUT_OF_RANGE(r || "offset", "an integer", t))
            );
        ...
        n.inherits(c, h),
          ...
          (c.prototype._update = function (t, e) {
            for (
              ...
              var R = s(o(u(r, f(S, n, i, h), t[p[S] + e], l(S)), y[S]), c);
              (r = c),
                (c = h),
                (h = o(i, 10)),
                (i = n),
                (n = R),
                (R = s(
                  o(u(v, f(79 - S, _, m, w), t[g[S] + e], d(S)), b[S]),
                  E
                )),
                (v = E),
                (E = w),
        ...
        n.inherits(l, c),
          ...
          (l.prototype._update = function (t, e) {
            ...
            for (n = 0; n < r.length; n++) {
              var p = ~~(n / 20),
                g = u(s(i, 5), h(p, o, c, l), d, r[n], f[p]);
              (d = l), (l = c), (c = s(o, 30)), (o = i), (i = g);
            }
      ...
      9344: (t, e, r) => {
        ...
        n.inherits(v, y),
          ...
          (v.prototype._update = function (t, e) {
            for (var r = this.W, n = 0; n < 16; n++) r[n] = t[e + n];
            for (; n < r.length; n++)
              r[n] = u(g(r[n - 2]), r[n - 7], p(r[n - 15]), r[n - 16]);
            var i = this.h[0],
              o = this.h[1],
              y = this.h[2],
              b = this.h[3],
            ...
            for (s(this.k.length === r.length), n = 0; n < r.length; n++) {
              var E = h(w, d(v), c(v, _, m), this.k[n], r[n]),
                S = a(l(i), f(i, o, y));
              (w = m),
                (m = _),
                (_ = v),
      ...
      5900: (t, e, r) => {
        ...
        n.inherits(_, b),
          ...
          (_.hmacStrength = 192),
          (_.padLength = 128),
          (_.prototype._prepareBlock = function (t, e) {
            ...
            for (; n < r.length; n += 2) {
              var i =
                ...
                l = r[n - 32],
                g = r[n - 31];
              (r[n] = d(i, o, a, h, c, f, l, g)),
                (r[n + 1] = p(i, o, a, h, c, f, l, g));
            }
            var y, b, v;
          }),
          (_.prototype._update = function (t, e) {
            ...
            for (var j = 0; j < a.length; j += 2) {
              var P = I,
                ...
                D =
                  ((i = void 0),
                  (i = s((r = x), (n = O), 14) ^ s(r, n, 18) ^ s(n, r, 9)) <
                    0 && (i += 4294967296),
                  i),
                q = A(x, O),
                z = m(x, 0, C, 0, B),
                ...
                W = a[j],
                G = a[j + 1],
                $ = g(P, N, D, q, z, K, H, F, W, G),
                V = y(P, N, D, q, z, K, H, F, W, G);
              (P = R(u, h)),
                (N = T(u, h)),
                (D = E(u, 0, d, 0, b)),
                (q = S(0, h, 0, p, 0, v));
              ...
              e = Math.abs(e),
                isNaN(e) || e === 1 / 0
                  ...
                  : ((s = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    (e += s + f >= 1 ? l / u : l * Math.pow(2, 1 - f)) * u >=
                      2 && (s++, (u /= 2)),
                    s + f >= c
                      ? ((a = 0), (s = c))
                      : s + f >= 1
      ...
      8725: (t, e, r) => {
        ...
        (e.fetch = s(r.g.fetch) && s(r.g.ReadableStream)),
          (e.writableStream = s(r.g.WritableStream)),
          (e.abortController = s(r.g.AbortController)),
      ...
      1989: (t, e, r) => {
        ...
        i(h, s.Writable),
          (h.prototype.setHeader = function (t, e) {
            var r = t.toLowerCase();
            -1 === c.indexOf(r) && (this._headers[r] = { name: t, value: e });
          }),
          ...
          (h.prototype._onFinish = function () {
            ...
            if (!t._destroyed) {
              ...
              if (
                ...
                var c = (t._xhr = new r.g.XMLHttpRequest());
                try {
      ...
      5676: (t, e, r) => {
        var n = r(8725),
          ...
          a = (e.IncomingMessage = function (t, e, r, i) {
            var s = this;
            if (
              (o.Readable.call(s),
              (s._mode = r),
              ...
              if (
                ...
                var a = new WritableStream({
                  ...
                  close: function () {
                    i(!0), s._destroyed || s.push(null);
                  },
                  abort: function (t) {
                    i(!0), s._destroyed || s.emit("error", t);
                  },
                });
                try {
                  return void e.body.pipeTo(a).catch(function (t) {
                    i(!0), s._destroyed || s.emit("error", t);
                  });
                } catch (t) {}
              }
              ...
              var h = s.rawHeaders["mime-type"];
              if (h) {
                var c = h.match(/;\s*charset=([^;])(;|$)/);
        ...
        i(a, o.Readable),
          ...
          (a.prototype._onXHRProgress = function (t) {
            var e = this,
              n = e._xhr,
              i = null;
            switch (e._mode) {
              case "text":
                if ((i = n.responseText).length > e._pos) {
                  var o = i.substr(e._pos);
                  if ("x-user-defined" === e._charset) {
                    for (
                      var a = Buffer.alloc(o.length), u = 0;
                      u < o.length;
                      u++
                    )
                      a[u] = 255 & o.charCodeAt(u);
                    e.push(a);
              ...
              case "arraybuffer":
                ...
                (i = n.response), e.push(Buffer.from(new Uint8Array(i)));
                break;
              case "moz-chunked-arraybuffer":
                if (((i = n.response), n.readyState !== s.LOADING || !i)) break;
                e.push(Buffer.from(new Uint8Array(i)));
                break;
              case "ms-stream":
                if (((i = n.response), n.readyState !== s.LOADING)) break;
                var h = new r.g.MSStreamReader();
                (h.onprogress = function () {
                  h.result.byteLength > e._pos &&
                    (e.push(
                      Buffer.from(new Uint8Array(h.result.slice(e._pos)))
                    ),
                    (e._pos = h.result.byteLength));
                }),
                  (h.onload = function () {
                    t(!0), e.push(null);
                  }),
      ...
      4002: (t, e, r) => {
        "use strict";
        var n;
        (t.exports = R), (R.ReadableState = S), r(7187).EventEmitter;
        var i,
          o = function (t, e) {
        ...
        function R(t) {
          if (((n = n || r(9560)), !(this instanceof R))) return new R(t);
        ...
        function T(t, e, r, n, o) {
          ...
          if (null === e)
            ...
            if (
              ...
              h.endEmitted ? w(t, new m()) : A(t, h, e, !0);
            else if (h.ended) w(t, new v());
            else {
              if (h.destroyed) return !1;
              (h.reading = !1),
                h.decoder && !r
                  ? ((e = h.decoder.write(e)),
                    h.objectMode || 0 !== e.length ? A(t, h, e, !1) : L(t, h))
                  : A(t, h, e, !1);
            }
          else n || ((h.reading = !1), L(t, h));
        ...
        function L(t, e) {
          e.readingMore || ((e.readingMore = !0), process.nextTick(B, t, e));
        }
        function B(t, e) {
          for (
            ;
        ...
        function N(t) {
          ...
          i("endReadable", e.endEmitted),
            e.endEmitted || ((e.ended = !0), process.nextTick(D, e, t));
        }
        function D(t, e) {
          if (
        ...
        (R.prototype.read = function (t) {
          ...
          if (
            ...
            return (
              ...
              0 === e.length && e.ended ? N(this) : O(this),
              null
            );
          ...
          (R.prototype.pipe = function (t, e) {
            ...
            function d() {
              i("onfinish"), t.removeListener("close", l), p();
            }
            function p() {
              i("unpipe"), r.unpipe(t);
            }
          ...
          (R.prototype.removeListener = function (t, e) {
            ...
            return "readable" === t && process.nextTick(U, this), r;
          }),
          (R.prototype.removeAllListeners = function (t) {
            var e = s.prototype.removeAllListeners.apply(this, arguments);
            return (
              ("readable" !== t && void 0 !== t) || process.nextTick(U, this), e
            );
          }),
          (R.prototype.resume = function () {
            ...
            return (
              t.flowing ||
                ...
                (function (t, e) {
                  e.resumeScheduled ||
                    ((e.resumeScheduled = !0), process.nextTick(M, t, e));
                })(this, t)),
              (t.paused = !1),
              this
            );
          ...
          "function" == typeof Symbol &&
            (R.prototype[Symbol.asyncIterator] = function () {
              return void 0 === f && (f = r(6819)), f(this);
            }),
          ...
          "function" == typeof Symbol &&
            (R.from = function (t, e) {
              return void 0 === l && (l = r(8869)), l(R, t, e);
            });
      },
      1846: (t, e, r) => {
        "use strict";
      ...
      3313: (t, e, r) => {
        ...
        var o,
          ...
          c = r(3369),
          f = r(624).getHighWaterMark,
          l = r(7303).q,
          d = l.ERR_INVALID_ARG_TYPE,
              ...
              !(function (t, e) {
                ...
                if (
                  ...
                  o ||
                    ...
                    !r.bufferedRequest ||
                    k(t, r),
                    n ? process.nextTick(A, t, r, o, i) : A(t, r, o, i);
                }
              })(e, t);
            }),
            (this.writecb = null),
        ...
        function R(t) {
          var e = this instanceof (i = i || r(9560));
          if (!e && !o.call(R, this)) return new R(t);
          ...
          if (t._writev && r && r.next) {
            ...
            for (; r; ) {
              var h = r.chunk,
                ...
                f = r.callback;
              if (
                (T(t, e, !1, e.objectMode ? 1 : h.length, h, c, f),
                (r = r.next),
        ...
        r(5717)(R, a),
          ...
          (R.prototype.write = function (t, e, r) {
            var n,
              ...
              o = !1,
              s = !i.objectMode && ((n = t), u.isBuffer(n) || n instanceof h);
            return (
              s &&
                !u.isBuffer(t) &&
                (t = (function (t) {
      ...
      6819: (t, e, r) => {
        ...
        function p(t) {
          ...
          if (null !== e) {
            var r = t[l].read();
            null !== r &&
              ((t[c] = null), (t[s] = null), (t[a] = null), e(d(r, !1)));
          }
        }
        function g(t) {
            ...
            r = Object.create(
              ...
              i(e, f, {
                value: function (t, e) {
                  var n = r[l].read();
                  n
                    ? ((r[c] = null), (r[s] = null), (r[a] = null), t(d(n, !1)))
                    : ((r[s] = t), (r[a] = e));
                },
                writable: !0,
              }),
          ...
          return (
            ...
            o(t, function (t) {
              if (t && "ERR_STREAM_PREMATURE_CLOSE" !== t.code) {
                ...
                return (
                  null !== e &&
                    ((r[c] = null), (r[s] = null), (r[a] = null), e(t)),
                  void (r[u] = t)
                );
              }
              var n = r[s];
      ...
      5467: (t, e, r) => {
        "use strict";
        var n = r(7303).q.ERR_STREAM_PREMATURE_CLOSE;
        function i() {}
      ...
      624: (t, e, r) => {
        "use strict";
        var n = r(7303).q.ERR_INVALID_OPT_VALUE;
        t.exports = {
      ...
      925: (t, e, r) => {
        ((e = t.exports = r(4002)).Stream = e),
          (e.Readable = e),
          (e.Writable = r(3313)),
          (e.Duplex = r(9560)),
          (e.Transform = r(1846)),
          (e.PassThrough = r(4842)),
          (e.finished = r(5467)),
          (e.pipeline = r(9689));
      },
      2553: (t, e, r) => {
          ...
          (function (i) {
            ...
            function b(t, e) {
              ...
              return (
                ...
                n + y((t = t.replace(f, ".")).split("."), e).join(".")
              );
            }
            function v(t) {
            ...
            function w(t, e, r) {
              var n = 0;
              for (t = r ? d(t / 700) : t >> 1, t += d(t / e); t > 455; n += u)
                t = d(t / 35);
            ...
            function E(t) {
              ...
              for ((r = t.lastIndexOf("-")) < 0 && (r = 0), n = 0; n < r; ++n)
                t.charCodeAt(n) >= 128 && g("not-basic"),
                ...
                for (
                  ...
                  i >= b && g("invalid-input"),
                    ((c =
                      ...
                      g("overflow"),
                    (v += c * s),
                    !(c < (f = h <= E ? 1 : h >= E + 26 ? 26 : h - E));
                  h += u
                )
                  s > d(a / (l = u - f)) && g("overflow"), (s *= l);
                (E = w(v - o, (e = y.length + 1), 0 == o)),
                  d(v / e) > a - m && g("overflow"),
                  (m += d(v / e)),
                  (v %= e),
                  y.splice(v++, 0, m);
              }
            ...
            function S(t) {
              var e,
                ...
                R = [];
              for (
                b = (t = v(t)).length, e = 128, r = 0, o = 72, s = 0;
                s < b;
                ++s
              )
                (y = t[s]) < 128 && R.push(p(y));
              for (n = i = R.length, i && R.push("-"); n < b; ) {
                for (h = a, s = 0; s < b; ++s)
                  (y = t[s]) >= e && y < h && (h = y);
                for (
                  h - e > d((a - r) / (_ = n + 1)) && g("overflow"),
                    r += (h - e) * _,
                    e = h,
                    s = 0;
                  s < b;
                  ...
                  if (((y = t[s]) < e && ++r > a && g("overflow"), y == e)) {
                    for (
                      ...
                      (S = c - l),
                        ...
                        R.push(p(m(l + (S % E), 0))),
                        (c = d(S / E));
                    R.push(p(m(c, 0))), (o = w(r, _, n == i)), (r = 0), ++n;
                  }
                ++r, ++e;
              }
              return R.join("");
      ...
      8575: (t, e, r) => {
        ...
        (o.prototype.parse = function (t, e, r) {
          ...
          if (w) {
            ...
            (this.protocol = E), (_ = _.substr(w.length));
          }
          if (r || w || _.match(/^\/\/[^@\/]+@[^@\/]+/)) {
            var S = "//" === _.substr(0, 2);
            !S || (w && y[w]) || ((_ = _.substr(2)), (this.slashes = !0));
          }
          if (!y[w] && (S || (w && !b[w]))) {
            for (var R, T, A = -1, k = 0; k < l.length; k++)
              -1 !== (x = _.indexOf(l[k])) && (-1 === A || x < A) && (A = x);
            for (
              -1 !==
                (T = -1 === A ? _.lastIndexOf("@") : _.lastIndexOf("@", A)) &&
                ((R = _.slice(0, T)),
                (_ = _.slice(T + 1)),
            ...
            if (!O)
              for (
                var C = this.hostname.split(/\./), L = ((k = 0), C.length);
                k < L;
                k++
              ) {
                var B = C[k];
                if (B && !B.match(d)) {
                  for (var U = "", I = 0, M = B.length; I < M; I++)
                    B.charCodeAt(I) > 127 ? (U += "x") : (U += B[I]);
                  if (!U.match(d)) {
                    var j = C.slice(0, k),
                      P = C.slice(k + 1),
                      N = B.match(p);
                    N && (j.push(N[1]), P.unshift(N[2])),
                      P.length && (_ = "/" + P.join(".") + _),
          ...
          if (!g[E])
            for (k = 0, L = c.length; k < L; k++) {
              ...
              if (-1 !== _.indexOf(z)) {
                ...
                K === z && (K = escape(z)), (_ = _.split(z).join(K));
              }
            }
          var H = _.indexOf("#");
          ...
          if (
            (-1 !== F
              ? ((this.search = _.substr(F)),
                (this.query = _.substr(F + 1)),
