...
async function createToken(issuer, maximum_supply){
	...
	console.log("\x1b[1;7;92m")
        console.log("CREATE Token transaction details")
        console.log("\x1b[0m")
        console.log(tx.processed)
        console.log("\x1b[1;7;92m")
        console.log("RPC Push transaction action Create Token details")
        console.log("\x1b[0m")
        console.log(tx.processed.action_traces[0].act)
    }catch(error){
        console.log(error)
        console.log("\x1b[1;7;91m")
        console.log("ERROR : Could not CREATE token symbol", symbol)
