<script lang="ts">
    ...
    let api_result: {} = {res: "Please click button ladsss!!"}
...
<svelte:head>
    <title>Rawr Dapp</title>
</svelte:head>

<div class="container mx-auto min-h-screen px-20 pb-20 pt-20">
    <div class="flex justify-center">
        <div on:click={() => goto("https://twitter.com/rawwriii")} class="avatar relative cursor-pointer mb-4">
...
<Modal modal_id="modal-create" modal_title="Build New Record on Inery" on:click={() => create()}>
    <div slot="body" class="flex flex-col gap-4">
        ...
        <input type="text" placeholder="rawrr" class="input input-bordered w-full max-w-xs" disabled />
