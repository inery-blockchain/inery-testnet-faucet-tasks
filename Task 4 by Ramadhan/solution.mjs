...
const url = "vmi1074242.contaboserver.net";

const json_rpc = new JsonRpc(url);
const private_key = process.env.PRIVATE_KEY; // import private key from .env file;

const account = "ramadhan";
const actor = "ramadhan";
...
const DestroyTrancsaction = async (id) => {
  try {
    ...
    console.log("Record destroyed by ramadhan\n\n");
...
PushTransaction(1020, account, "push transaction task 4 by ramadhan");