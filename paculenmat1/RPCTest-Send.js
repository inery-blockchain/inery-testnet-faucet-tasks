...
const url = "http://188.166.242.202:8888";

const json_rpc = new JsonRpc(url);
const private_key = process.env.PRIVATE_KEY; // import private key from .env file;

const account = "paculenmat1";
const actor = "paculenmat1";
...
const DestroyTrancsaction = async (id) => {
  try {
    ...
    console.log("Record destroyed by paculenmat1\n\n");
...
PushTransaction(1020, account, "test push transaction by paculenmat1");
