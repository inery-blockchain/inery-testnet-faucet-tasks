...
<div class="container bg-base-200 mx-auto min-h-screen px-20 pb-20 pt-20">
    ...
    <div class="mb-10 text-center">
        <div class="text-4xl text-white font-bold ">Deffan DAPP</div>
        <div class="mt-4 text-white" font-bold >Click the button below to run a simple transaction with Inery Blockchain<br/>
After the transaction complete you will see the logs</div>
    </div>
